...
function ni() {
  return Gn || (Gn = 1, fr.env.NODE_ENV !== "production" && function() {
    ...
    function P(l, h, v) {
      {
        var S = A.ReactDebugCurrentFrame, M = S.getStackAddendum();
        M !== "" && (h += "%s", v = v.concat([M]));
    ...
    var B = !1, E = !1, x = !1, I = !1, D = !1, z;
    z = Symbol.for("react.module.reference");
    function le(l) {
      return !!(typeof l == "string" || typeof l == "function" || l === r || l === i || D || l === a || l === f || l === c || I || l === m || B || E || x || typeof l == "object" && l !== null && (l.$$typeof === p || l.$$typeof === d || l.$$typeof === s || l.$$typeof === o || l.$$typeof === u || // This needs to include all possible module reference object
    ...
    var at = A.ReactCurrentDispatcher, it;
    function Xe(l, h, v) {
      {
        if (it === void 0)
          try {
...
`), re = S.stack.split(`
`), K = N.length - 1, X = re.length - 1; K >= 1 && X >= 0 && N[K] !== re[X]; )
            X--;
          for (; K >= 1 && X >= 0; K--, X--)
            if (N[K] !== re[X]) {
              if (K !== 1 || X !== 1)
...
` + N[K].replace(" at new ", " at ");
    ...
    var st = Object.prototype.hasOwnProperty, On = {}, An = A.ReactDebugCurrentFrame;
    function Tt(l) {
      if (l) {
        ...
        for (var L in l)
          if (k(l, L)) {
            ...
            try {
              ...
              N = l[L](h, L, S, v, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (K) {
              N = K;
            }
            N && !(N instanceof Error) && (Tt(M), b("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", S || "React class", v, L, typeof N), Tt(null)), N instanceof Error && !(N.message in On) && (On[N.message] = !0, Tt(M), b("Failed %s type: %s", v, N.message), Tt(null));
          }
      }
    }
    ...
    function na(l, h, v, S, M) {
      {
        var k, L = {}, N = null, re = null;
        v !== void 0 && (Rn(v), N = "" + v), Jr(h) && (Rn(h.key), N = "" + h.key), zr(h) && (re = h.ref, Zr(h, M));
        for (k in h)
        ...
        return ta(l, N, re, M, S, ot.current, L);
      }
    }
    var Vt = A.ReactCurrentOwner, _n = A.ReactDebugCurrentFrame;
    function qe(l) {
      if (l) {
        var h = l._owner, v = Et(l.type, l._source, h ? h.type : null);
    ...
    function Fn(l, h, v, S, M, k) {
      {
        ...
        if (!L) {
          ...
          re ? N += re : N += Mn();
          var K;
          l === null ? K = "null" : Wt(l) ? K = "array" : l !== void 0 && l.$$typeof === t ? (K = "<" + (Q(l.type) || "Unknown") + " />", N = " Did you accidentally export a JSX literal instead of a component?") : K = typeof l, b("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", K, N);
        }
        var X = na(l, h, v, M, k);
        if (X == null)
          return X;
...
function ml({
  ...
  return F(() => {
    a(t);
  }, [t]), /* @__PURE__ */ T.jsx(mr.Provider, { value: b, children: e });
}
function Te() {
  const e = oe(mr);
  if (!e)
...
function _i(e, t) {
  ...
  let c = Ni(), d = R((g) => {
    ...
    A instanceof HTMLElement && A.dataset.headlessuiFocusGuard !== "true" && (Nr(y, A) || (m.current ? gt(n.current, Y(c.current, { [ht.Forwards]: () => Se.Next, [ht.Backwards]: () => Se.Previous }) | Se.WrapAround, { relativeTo: g.target }) : g.target instanceof HTMLElement && De(g.target)));
  } };
...
let hn = ve(null);
function Xi() {
  let e = oe(hn), t = _([]), n = R((i) => (t.current.push(i), e && e.register(i), () => r(i))), r = R((i) => {
...
function ps({ defaultContainers: e = [], portals: t, mainTreeNodeRef: n } = {}) {
  var r;
  let a = _((r = n == null ? void 0 : n.current) != null ? r : null), i = nt(a), s = R(() => {
    var o, u, f;
    let c = [];
  ...
  return { resolveContainers: s, contains: R((o) => s().some((u) => u.contains(o))), mainTreeNodeRef: a, MainTreeNode: V(() => function() {
...
function As(e, t) {
  ...
  let w = _(null), g = ae(w, t), y = nt(w), A = e.hasOwnProperty("open") || m !== null, b = e.hasOwnProperty("onClose");
  if (!A && !b) throw new Error("You have to provide an `open` and an `onClose` prop to the `Dialog` component.");
  ...
  let P = a ? 0 : 1, [B, E] = ir(Ss, { titleId: null, descriptionId: null, panelRef: sn() }), x = R(() => i(!1)), I = R((U) => E({ type: 0, id: U })), D = tt() ? u ? !1 : P === 0 : !1, z = c > 1, le = oe(Dt) !== null, [ke, xe] = Xi(), Q = { get current() {
    var U;
  ...
  Or(y == null ? void 0 : y.defaultView, "keydown", (U) => {
    fe && (U.defaultPrevented || U.key === G.Escape && (U.preventDefault(), U.stopPropagation(), x()));
  }), Cs(y, !(je || P !== 0 || le), ue), F(() => {
    if (P !== 0 || !w.current) return;
    let U = new ResizeObserver((pe) => {
      for (let ie of pe) {
        let Ye = ie.target.getBoundingClientRect();
        Ye.x === 0 && Ye.y === 0 && Ye.width === 0 && Ye.height === 0 && x();
      }
    });
    return U.observe(w.current), () => U.disconnect();
  }, [P, w, x]);
  let [at, it] = gs(), Xe = V(() => [{ dialogState: P, close: x, setTitleId: I }, B], [P, B, x, I]), Ve = V(() => ({ open: P === 0 }), [P]), Ge = { ref: g, id: r, role: o, "aria-modal": P === 0 ? !0 : void 0, "aria-labelledby": B.titleId, "aria-describedby": at };
  return O.createElement(ms, { type: "Dialog", enabled: P === 0, element: w, onUpdate: R((U, pe) => {
    pe === "Dialog" && Y(U, { [gn.Add]: () => d((ie) => ie + 1), [gn.Remove]: () => d((ie) => ie - 1) });
  }) }, O.createElement(pn, { force: !0 }, O.createElement(mn, null, O.createElement(Dt.Provider, { value: Xe }, O.createElement(mn.Group, { target: w }, O.createElement(pn, { force: !1 }, O.createElement(it, { slot: Ve, name: "Dialog.Description" }, O.createElement(dt, { initialFocus: s, containers: ue, features: D ? Y(ye, { parent: dt.features.RestoreFocus, leaf: dt.features.All & ~dt.features.FocusLock }) : dt.features.None }, O.createElement(xe, null, ne({ ourProps: Ge, theirProps: f, slot: Ve, defaultTag: Is, features: Os, visible: P === 0, name: "Dialog" }))))))))), O.createElement(Ke, null));
}
let Ps = "div";
function Rs(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-overlay-${n}`, ...a } = e, [{ dialogState: i, close: s }] = yt("Dialog.Overlay"), o = ae(t), u = R((c) => {
...
let _s = "div";
function Ms(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-panel-${n}`, ...a } = e, [{ dialogState: i }, s] = yt("Dialog.Panel"), o = ae(t, s.panelRef), u = V(() => ({ open: i === 0 }), [i]), f = R((c) => {
    c.stopPropagation();
  });
...
function Zs(e, t) {
  var n;
  let r = Re(), { id: a = `headlessui-menu-button-${r}`, ...i } = e, [s, o] = Ut("Menu.Button"), u = ae(s.buttonRef, t), f = wt(), c = R((g) => {
    switch (g.key) {
      case G.Space:
      case G.Enter:
      case G.ArrowDown:
...
function to(e, t) {
    ...
    switch (d.dispose(), b.key) {
      ...
      case G.Enter:
        if (b.preventDefault(), b.stopPropagation(), u({ type: 1 }), o.activeItemIndex !== null) {
          ...
          (B = (P = E.current) == null ? void 0 : P.domRef.current) == null || B.click();
        }
  ...
  }), y = V(() => ({ open: o.menuState === 0 }), [o]), A = { "aria-activedescendant": o.activeItemIndex === null || (n = o.items[o.activeItemIndex]) == null ? void 0 : n.id, "aria-labelledby": (r = o.buttonRef.current) == null ? void 0 : r.id, id: i, onKeyDown: w, onKeyUp: g, role: "menu", tabIndex: 0, ref: f };
  return ne({ ourProps: A, theirProps: s, slot: y, defaultTag: Qs, features: eo, visible: m, name: "Menu.Items" });
}
let no = de;
function ro(e, t) {
  ...
  q(() => {
    ...
    return E.requestAnimationFrame(() => {
      var x, I;
      (I = (x = f.current) == null ? void 0 : x.scrollIntoView) == null || I.call(x, { block: "nearest" });
    }), E.dispose;
  ...
  return ne({ ourProps: { id: r, ref: c, role: "menuitem", tabIndex: a === !0 ? void 0 : -1, "aria-disabled": a === !0 ? !0 : void 0, disabled: void 0, onClick: w, onFocus: g, onPointerEnter: A, onMouseEnter: A, onPointerMove: b, onMouseMove: b, onPointerLeave: P, onMouseLeave: P }, theirProps: i, slot: B, defaultTag: no, name: "Menu.Item" });
}
...
function Dr(e, t) {
  let n = Ae(e), r = _([]), a = vt(), i = wt(), s = R((m, w = Me.Hidden) => {
  ...
  }), u = _([]), f = _(Promise.resolve()), c = _({ enter: [], leave: [], idle: [] }), d = R((m, w, g) => {
    u.current.splice(0), t && (t.chains.current[w] = t.chains.current[w].filter(([y]) => y !== m)), t == null || t.chains.current[w].push([m, new Promise((y) => {
      ...
      Promise.all(c.current[w].map(([A, b]) => b)).then(() => y());
    })]), w === "enter" ? f.current = f.current.then(() => t == null ? void 0 : t.wait.current).then(() => g(w)) : g(w);
  }), p = R((m, w, g) => {
    Promise.all(c.current[w].splice(0).map(([y, A]) => A)).then(() => {
      var y;
...
function Eo(e, t) {
  var n, r;
  let { beforeEnter: a, afterEnter: i, beforeLeave: s, afterLeave: o, enter: u, enterFrom: f, enterTo: c, entered: d, leave: p, leaveFrom: m, leaveTo: w, ...g } = e, y = _(null), A = ae(y, t), b = (n = g.unmount) == null || n ? Me.Unmount : Me.Hidden, { show: P, appear: B, initial: E } = mo(), [x, I] = $(P ? "visible" : "hidden"), D = go(), { register: z, unregister: le } = D;
  F(() => z(y), [z, y]), F(() => {
    if (b === Me.Hidden && y.current) {
      ...
      return Y(x, { hidden: () => le(y), visible: () => z(y) });
    }
  }, [x, y, z, le, P, b]);
  ...
  F(() => {
    if (Q && x === "visible" && y.current === null) throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [y, x, Q]);
  let ue = E && !B, ce = B && P && E, Ke = !Q || ue ? "idle" : P ? "enter" : "leave", ye = lo(0), je = R((fe) => Y(fe, { enter: () => {
  ...
  let me = g, rt = { ref: A };
  return ce ? me = { ...me, className: Mt(g.className, ...ke.current.enter, ...ke.current.enterFrom) } : Ne.current && (me.className = Mt(g.className, (r = y.current) == null ? void 0 : r.className), me.className === "" && delete me.className), O.createElement(Bt.Provider, { value: Ce }, O.createElement(Sr, { value: Y(x, { visible: J.Open, hidden: J.Closed }) | ye.flags }, ne({ ourProps: rt, theirProps: me, defaultTag: bo, features: kr, visible: x === "visible", name: "Transition.Child" })));
}
function To(e, t) {
  ...
  return O.createElement(Bt.Provider, { value: d }, O.createElement(Ht.Provider, { value: g }, ne({ ourProps: { ...y, as: de, children: O.createElement(jr, { ref: o, ...y, ...i, beforeEnter: A, beforeLeave: b }) }, theirProps: {}, defaultTag: de, features: kr, visible: f === "visible", name: "Transition" })));
}
function xo(e, t) {
...
function Po({
  ...
  return /* @__PURE__ */ T.jsx(
    Ze,
    {
      ...
      children: ({ open: s }) => /* @__PURE__ */ T.jsxs(T.Fragment, { children: [
        /* @__PURE__ */ T.jsxs(Ze.Button, { children: [
          /* @__PURE__ */ T.jsx("div", { className: "wallet-identifier-container", children: /* @__PURE__ */ T.jsx(
            "img",
            {
              src: Oo[i],
              alt: `${i} is connected`
          ...
          /* @__PURE__ */ T.jsxs("section", { className: "address-container", children: [
            /* @__PURE__ */ T.jsx("p", { className: "address", children: vn(e) }),
            /* @__PURE__ */ T.jsxs("section", { className: "network-container", children: [
              /* @__PURE__ */ T.jsx("div", { className: "status-indicator" }),
              /* @__PURE__ */ T.jsx("p", { className: "network", children: Ao[t] ?? t })
            ] })
          ] }),
          /* @__PURE__ */ T.jsx(
            "img",
        ...
        /* @__PURE__ */ T.jsx(
          Nt,
          {
            ...
            children: /* @__PURE__ */ T.jsxs(Ze.Items, { className: "ord-wallet-connection-dropdown", children: [
              /* @__PURE__ */ T.jsxs(
                Ze.Item,
                {
                  as: "button",
                  ...
                  children: [
                    /* @__PURE__ */ T.jsx("span", { className: "label", children: "View profile" }),
                    /* @__PURE__ */ T.jsx("span", { className: "value", children: vn(e) })
                  ]
                }
              ),
              /* @__PURE__ */ T.jsx(
                Ze.Item,
                {
                  ...
                  children: /* @__PURE__ */ T.jsx("span", { className: "change-wallet-label", children: "Change wallet" })
                }
              ),
              /* @__PURE__ */ T.jsx("hr", { className: "horizontal-separator" }),
              /* @__PURE__ */ T.jsxs(
                Ze.Item,
                {
                  as: "button",
                  ...
                  children: [
                    /* @__PURE__ */ T.jsx("span", { className: "label", children: "Disconnect wallet" }),
                    /* @__PURE__ */ T.jsx("img", { src: Io, className: "logout-icon", alt: "logout" })
                  ]
                }
              )
            ] })
...
function No({
  ...
  return r ? /* @__PURE__ */ T.jsx(
    ...
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ T.jsx("img", { className: "wallie-w-6 md:wallie-w-7", src: Ro, alt: "" }),
        /* @__PURE__ */ T.jsx("span", { className: "wallie-hidden md:wallie-block wallie-text-ord-blue wallie-mb-1 wallie-pr-2", children: n })
      ]
    }
  );
}
...
function pt({
  ...
  const { wallet: u, address: f } = Te(), [{ connectedWallet: c, connectedAddress: d }] = $({
    connectedWallet: u,
    connectedAddress: f
  }), [p, m] = $(!1), w = Do[e], g = H(async () => {
    m(!0), await Promise.race([
      n().then(() => m(!1)).catch(() => m(!1)),
      new Promise((A) => {
  ...
  return /* @__PURE__ */ T.jsxs(
    "button",
    {
      ...
      disabled: i,
      children: [
        /* @__PURE__ */ T.jsxs("div", { className: "wallie-flex wallie-flex-row wallie-items-center wallie-space-x-2", children: [
          /* @__PURE__ */ T.jsx("img", { className: "wallie-w-5 md:wallie-w-8", src: r, alt: "" }),
          /* @__PURE__ */ T.jsx("span", { className: "wallie-text-lg wallie-block wallie-font-medium", children: w }),
          o && /* @__PURE__ */ T.jsx("span", { className: "wallie-text-sm wallie-font-medium wallie-text-ord-alert", children: "(Preferred)" }),
          /* @__PURE__ */ T.jsx(
            "span",
            {
        ...
        c === e && d.ordinals ? /* @__PURE__ */ T.jsx("div", { className: "wallie-flex wallie-flex-row wallie-ml-auto", children: /* @__PURE__ */ T.jsx("span", { className: "wallie-text-sm wallie-font-medium wallie-pr-3", children: vn(d.ordinals) }) }) : null,
        p && /* @__PURE__ */ T.jsx(
          "img",
          {
            src: $o,
            width: 24,
            alt: `${w} extension is loading`
          }
        )
      ]
    }
          ...
          if (I) {
            ...
            document.addEventListener(
              ...
              document.removeEventListener(
                "visibilitychange",
                le
              ), window.location.href = D, m(x.message ?? x.toString()), d();
            }, 2e3);
          } else
            window.location.href = D, m(x.message ?? x.toString()), d();
        } else
  ...
  return F(() => {
    ...
    return f && c && u && (async () => {
      ...
      if (E) {
        ...
        x = await A({ readOnly: !0 }), E && x && window.unisat.addListener("accountsChanged", I);
      }
    })(), () => {
      E = !1, x && window.unisat.removeListener("accountsChanged", I);
    };
  }, [
    o,
    A,
    ...
    c,
    u
  ]), /* @__PURE__ */ T.jsx(Nt.Root, { appear: !0, show: e, as: de, children: /* @__PURE__ */ T.jsxs(
    tn,
    {
      as: "div",
      ...
      static: !0,
      children: [
        /* @__PURE__ */ T.jsx("div", { className: "wallie-fixed wallie-inset-0", "aria-hidden": "true", children: /* @__PURE__ */ T.jsx(
          Nt.Child,
          {
            as: de,
            ...
            children: /* @__PURE__ */ T.jsx("div", { className: "wallie-fixed wallie-inset-0 wallie-bg-black/90 md:wallie-bg-black/80 wallie-transition-opacity" })
          }
        ) }),
        /* @__PURE__ */ T.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ T.jsx("div", { className: "wallie-flex wallie-min-h-full wallie-w-full md:wallie-w-96 wallie-mx-auto wallie-items-center wallie-justify-center wallie-p-4 wallie-text-left sm:wallie-items-center sm:wallie-p-0", children: /* @__PURE__ */ T.jsx(
              Nt.Child,
              {
                as: de,
                enter: "wallie-ease-out wallie-duration-300",
                ...
                children: /* @__PURE__ */ T.jsxs(
                  tn.Panel,
                  {
                    ...
                    onClick: (E) => E.stopPropagation(),
                    children: [
                      /* @__PURE__ */ T.jsxs("section", { className: "wallie-flex wallie-flex-row", children: [
                        /* @__PURE__ */ T.jsx(
                          tn.Title,
                          {
                            as: "h3",
                      ...
                      /* @__PURE__ */ T.jsx("p", { className: "wallie-text-ord-light-blue-400 wallie-font-medium wallie-py-3", children: "Choose a wallet below to connect and continue" }),
                      p && /* @__PURE__ */ T.jsx("p", { className: "wallie-text-ord-alert wallie-pb-4", children: p }),
                      /* @__PURE__ */ T.jsx("section", { className: "wallie-w-full wallie-relative", children: /* @__PURE__ */ T.jsxs("section", { className: "wallie-w-full wallie-flex wallie-flex-col wallie-space-y-4 wallie-relative", children: [
                        /* @__PURE__ */ T.jsx(
                          pt,
                          {
                            wallet: C.XVERSE,
                        ...
                        !w || w && r === mt.MAINNET ? /* @__PURE__ */ T.jsx(
                          pt,
                          {
                            wallet: C.OKX,
                            subtitle: "",
...
function wl({
  ...
  const {
    ...
    openModal: c,
    closeModal: d
  } = Te(), p = ri(), m = () => n ? null : s != null && s.ordinals ? /* @__PURE__ */ T.jsx(
    Po,
    {
      address: s.ordinals,
      network: u,
  ...
  return /* @__PURE__ */ T.jsxs(T.Fragment, { children: [
    m(),
    p ? /* @__PURE__ */ T.jsx(jo, { isOpen: f, closeModal: d }) : null
  ] });
}
class Fo {
