...
import O, { useState as $, useEffect as F, useCallback as H, createContext as ve, useMemo as V, useContext as oe, useLayoutEffect as ma, useRef as _, forwardRef as ga, Fragment as de, isValidElement as wa, cloneElement as va, createElement as ya, useReducer as ir, createRef as sn } from "react";
import { g as ba, s as Ea, l as Ta, a as xa, L as Un } from "./index-8ymGC9fB.js";
import { getAddresses as Ca, signPsbt as Sa, getMagicEdenWalletProvider as Ia, signMessage as Oa } from "./magiceden.js";
import { getAddresses as Aa, signPsbt as Pa, signMessage as Ra } from "./okx.js";
import { getAddresses as Na, signPsbt as La, signMessage as _a } from "./unisat.js";
import { getAddresses as Ma, signPsbt as $a, signMessage as Da } from "./xverse.js";
import { B as ka, U as ja, O as te, o as Hn, g as Fa, A as Ua, a as Lt, M as Ha, b as Bn, c as Ba, d as Be, C as Ka, t as sr, e as or, I as Wa, f as lt, h as zt, i as Xa } from "./index-DpaD9iwk.js";
import { createPortal as Va } from "react-dom";
import Kn from "bignumber.js";
import { Transaction as on, Psbt as _t } from "bitcoinjs-lib";
import "ecpair";
import "@bitcoinerlab/secp256k1";
import Wn from "cross-fetch";
import Ga from "buffer-reverse";
import { sendBtcTransaction as Ya, BitcoinNetworkType as Xn, request as qa, RpcErrorCode as za } from "sats-connect";
function Ja(e) {
  return e && e.__esModule && Object.prototype.hasOwnProperty.call(e, "default") ? e.default : e;
}
var lr = { exports: {} }, W = lr.exports = {}, be, Ee;
function ln() {
...
(function() {
  ...
  try {
    typeof clearTimeout == "function" ? Ee = clearTimeout : Ee = un;
  } catch {
    Ee = un;
  }
})();
...
var Ie = [], Qe = !1, Ue, Rt = -1;
function Qa() {
  !Qe || !Ue || (Qe = !1, Ue.length ? Ie = Ue.concat(Ie) : Rt = -1, Ie.length && cr());
}
function cr() {
  if (!Qe) {
    var e = ur(Qa);
...
W.nextTick = function(e) {
  ...
  if (arguments.length > 1)
    for (var n = 1; n < arguments.length; n++)
      t[n - 1] = arguments[n];
  Ie.push(new dr(e, t)), Ie.length === 1 && !Qe && ur(cr);
};
function dr(e, t) {
...
W.off = Pe;
W.removeListener = Pe;
W.removeAllListeners = Pe;
W.emit = Pe;
W.prependListener = Pe;
W.prependOnceListener = Pe;
...
function ti() {
  if (Vn) return ut;
  Vn = 1;
  var e = O, t = Symbol.for("react.element"), n = Symbol.for("react.fragment"), r = Object.prototype.hasOwnProperty, a = e.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, i = { key: !0, ref: !0, __self: !0, __source: !0 };
  function s(o, u, f) {
...
function ni() {
  return Gn || (Gn = 1, fr.env.NODE_ENV !== "production" && function() {
    ...
    var B = !1, E = !1, T = !1, I = !1, D = !1, z;
    z = Symbol.for("react.module.reference");
    function le(l) {
      return !!(typeof l == "string" || typeof l == "function" || l === r || l === i || D || l === a || l === f || l === c || I || l === m || B || E || T || typeof l == "object" && l !== null && (l.$$typeof === p || l.$$typeof === d || l.$$typeof === s || l.$$typeof === o || l.$$typeof === u || // This needs to include all possible module reference object
    ...
    function Q(l) {
      ...
      if (typeof l == "object")
        switch (l.$$typeof) {
          ...
          case s:
            var v = l;
            return xe(v._context) + ".Provider";
          case u:
            return ke(l, l.render, "ForwardRef");
          case d:
            var S = l.displayName || null;
            return S !== null ? S : Q(l.type) || "Memo";
          case p: {
            var M = l, k = M._payload, L = M._init;
            try {
              return Q(L(k));
            } catch {
              return null;
    ...
    var ue = Object.assign, ce = 0, Ke, ye, je, We, Ce, Ne, me;
    function rt() {
    }
    ...
    function fe() {
      {
        if (ce === 0) {
          Ke = console.log, ye = console.info, je = console.warn, We = console.error, Ce = console.group, Ne = console.groupCollapsed, me = console.groupEnd;
          var l = {
            configurable: !0,
            enumerable: !0,
            value: rt,
    ...
    var at = N.ReactCurrentDispatcher, it;
    function Xe(l, h, v) {
      {
        if (it === void 0)
          try {
...
` + it + l;
    ...
    function pe(l, h) {
      ...
      var k;
      k = at.current, at.current = null, fe();
      try {
        if (h) {
          var L = function() {
            throw Error();
...
`), re = S.stack.split(`
`), K = R.length - 1, X = re.length - 1; K >= 1 && X >= 0 && R[K] !== re[X]; )
            X--;
          for (; K >= 1 && X >= 0; K--, X--)
            if (R[K] !== re[X]) {
              if (K !== 1 || X !== 1)
...
` + R[K].replace(" at new ", " at ");
                    return l.displayName && he.includes("<anonymous>") && (he = he.replace("<anonymous>", l.displayName)), typeof l == "function" && Ge.set(l, he), he;
                  }
                while (K >= 1 && X >= 0);
              break;
            }
        ...
        Ve = !1, at.current = k, In(), Error.prepareStackTrace = M;
      }
      var ze = l ? l.displayName || l.name : "", Fe = ze ? Xe(ze) : "";
      ...
      if (typeof l == "object")
        switch (l.$$typeof) {
          case u:
            return ie(l.render);
          case d:
            return Et(l.type, h, v);
          case p: {
            var S = l, M = S._payload, k = S._init;
            try {
              return Et(k(M), h, v);
            } catch {
            }
    ...
    var st = Object.prototype.hasOwnProperty, On = {}, An = N.ReactDebugCurrentFrame;
    function Tt(l) {
      if (l) {
        var h = l._owner, v = Et(l.type, l._source, h ? h.type : null);
        An.setExtraStackFrame(v);
      } else
        An.setExtraStackFrame(null);
    }
    function Xr(l, h, v, S, M) {
      {
        var k = Function.call.bind(st);
        for (var L in l)
          if (k(l, L)) {
            var R = void 0;
            try {
              if (typeof l[L] != "function") {
                var re = Error((S || "React class") + ": " + v + " type `" + L + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof l[L] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw re.name = "Invariant Violation", re;
              }
              R = l[L](h, L, S, v, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (K) {
              R = K;
            }
            R && !(R instanceof Error) && (Tt(M), b("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", S || "React class", v, L, typeof R), Tt(null)), R instanceof Error && !(R.message in On) && (On[R.message] = !0, Tt(M), b("Failed %s type: %s", v, R.message), Tt(null));
          }
      }
    }
    ...
    function Gr(l) {
      {
        var h = typeof Symbol == "function" && Symbol.toStringTag, v = h && l[Symbol.toStringTag] || l.constructor.name || "Object";
        return v;
      }
    }
    function Yr(l) {
    ...
    function Rn(l) {
      if (Yr(l))
        return b("The provided key is an unsupported type %s. This value must be coerced to a string before before using it here.", Gr(l)), Pn(l);
    }
    var ot = N.ReactCurrentOwner, qr = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function Zr(l, h) {
      if (typeof l.ref == "string" && ot.current && h && ot.current.stateNode !== h) {
        var v = Q(ot.current.type);
        Xt[v] || (b('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', Q(ot.current.type), l.ref), Xt[v] = !0);
      }
    }
    function Qr(l, h) {
      {
        var v = function() {
          Nn || (Nn = !0, b("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", h));
        };
    ...
    function ea(l, h) {
      {
        var v = function() {
          Ln || (Ln = !0, b("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", h));
        };
    ...
    function na(l, h, v, S, M) {
      {
        var k, L = {}, R = null, re = null;
        v !== void 0 && (Rn(v), R = "" + v), Jr(h) && (Rn(h.key), R = "" + h.key), zr(h) && (re = h.ref, Zr(h, M));
        for (k in h)
          st.call(h, k) && !qr.hasOwnProperty(k) && (L[k] = h[k]);
        if (l && l.defaultProps) {
        ...
        return ta(l, R, re, M, S, ot.current, L);
      }
    }
    var Vt = N.ReactCurrentOwner, _n = N.ReactDebugCurrentFrame;
    function qe(l) {
      if (l) {
        var h = l._owner, v = Et(l.type, l._source, h ? h.type : null);
        _n.setExtraStackFrame(v);
      } else
...
Check the top-level render call using <` + v + ">.");
    ...
    function Dn(l, h) {
      {
        ...
        $n[v] = !0;
        var S = "";
        l && l._owner && l._owner !== Vt.current && (S = " It was passed a child from " + Q(l._owner.type) + "."), qe(l), b('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', v, S), qe(null);
      }
    }
    function kn(l, h) {
      {
        ...
        if (Wt(l))
          ...
          var M = y(l);
          if (typeof M == "function" && M !== l.entries)
            for (var k = M.call(l), L; !(L = k.next()).done; )
    ...
    function sa(l) {
      {
        for (var h = Object.keys(l.props), v = 0; v < h.length; v++) {
          var S = h[v];
          if (S !== "children" && S !== "key") {
            qe(l), b("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", S), qe(null);
            break;
          }
        }
        l.ref !== null && (qe(l), b("Invalid attribute `ref` supplied to `React.Fragment`."), qe(null));
      }
    }
    var jn = {};
    function Fn(l, h, v, S, M, k) {
      {
        var L = le(l);
        if (!L) {
          var R = "";
          ...
          re ? R += re : R += Mn();
          var K;
          l === null ? K = "null" : Wt(l) ? K = "array" : l !== void 0 && l.$$typeof === t ? (K = "<" + (Q(l.type) || "Unknown") + " />", R = " Did you accidentally export a JSX literal instead of a component?") : K = typeof l, b("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", K, R);
        }
        var X = na(l, h, v, M, k);
        if (X == null)
          return X;
        ...
        if (st.call(h, "key")) {
          var Fe = Q(l), se = Object.keys(h).filter(function(fa) {
            return fa !== "key";
          }), qt = se.length > 0 ? "{key: someKey, " + se.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!jn[Fe + qt]) {
            var da = se.length > 0 ? "{" + se.join(": ..., ") + ": ...}" : "{}";
            b(`A props object containing a "key" prop is being spread into JSX:
  let props = %s;
  <%s {...props} />
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, qt, Fe, da, Fe), jn[Fe + qt] = !0;
          }
        }
        return l === r ? sa(X) : ia(X), X;
      }
    }
    function oa(l, h, v) {
      return Fn(l, h, v, !0);
    ...
    var ua = la, ca = oa;
    ct.Fragment = r, ct.jsx = ua, ct.jsxs = ca;
  }()), ct;
}
fr.env.NODE_ENV === "production" ? cn.exports = ti() : cn.exports = ni();
var x = cn.exports;
function ri() {
  const [e, t] = $(!1);
  return F(() => {
...
function xt(e, t, n = {}) {
  const { initializeWithValue: r = !0 } = n, a = H(() => {
    const u = ai(e);
    return u || (Yn(e, t), t);
  }, [t, e]), [i, s] = $(() => r ? a() : t), o = H(
    (u) => {
...
var mt = /* @__PURE__ */ ((e) => (e.MAINNET = "mainnet", e.TESTNET = "testnet", e.SIGNET = "signet", e))(mt || {}), C = /* @__PURE__ */ ((e) => (e.UNISAT = "unisat", e.XVERSE = "xverse", e.MAGICEDEN = "magiceden", e.LEATHER = "leather", e.OKX = "okx", e))(C || {});
const Je = {
  payments: null,
  ordinals: null
}, mr = ve(void 0), ii = "address", si = "wallet", oi = "publicKey", li = "format";
function ml({
  children: e,
  initialNetwork: t,
  ssr: n = !1
  ...
  const [r, a] = $(t), [i, s] = xt(
    ...
    Je,
    { initializeWithValue: !n }
  ), [m, w] = $(!1), g = H(() => w(!0), []), y = H(() => w(!1), []), N = H(() => {
    s(Je), c(Je), p(Je), u(null);
  }, [s, p, c, u]), b = V(
    () => ({
      address: i,
      updateAddress: s,
  ...
  return F(() => {
    a(t);
  }, [t]), /* @__PURE__ */ x.jsx(mr.Provider, { value: b, children: e });
}
function Te() {
  const e = oe(mr);
  if (!e)
...
var ui = Object.defineProperty, ci = (e, t, n) => t in e ? ui(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, Jt = (e, t, n) => (ci(e, typeof t != "symbol" ? t + "" : t, n), n);
let di = class {
  constructor() {
    Jt(this, "current", this.detect()), Jt(this, "handoffState", "pending"), Jt(this, "currentId", 0);
  }
  set(t) {
...
function tt() {
  let e = fi(), [t, n] = $e.useState(Oe.isHandoffComplete);
...
var Se = ((e) => (e[e.First = 1] = "First", e[e.Previous = 2] = "Previous", e[e.Next = 4] = "Next", e[e.Last = 8] = "Last", e[e.WrapAround = 16] = "WrapAround", e[e.NoScroll = 32] = "NoScroll", e))(Se || {}), gr = ((e) => (e[e.Error = 0] = "Error", e[e.Overflow = 1] = "Overflow", e[e.Success = 2] = "Success", e[e.Underflow = 3] = "Underflow", e))(gr || {}), pi = ((e) => (e[e.Previous = -1] = "Previous", e[e.Next = 1] = "Next", e))(pi || {});
...
var yn = ((e) => (e[e.Strict = 0] = "Strict", e[e.Loose = 1] = "Loose", e))(yn || {});
function bn(e, t = 0) {
  var n;
  return e === ((n = jt(e)) == null ? void 0 : n.body) ? !1 : Y(t, { 0() {
    return e.matches(dn);
  }, 1() {
    let r = e;
    for (; r !== null; ) {
...
function vr(e) {
  let t = jt(e);
  we().nextFrame(() => {
    t && !bn(t.activeElement, 0) && De(e);
  });
}
var hi = ((e) => (e[e.Keyboard = 0] = "Keyboard", e[e.Mouse = 1] = "Mouse", e))(hi || {});
...
let mi = ["textarea", "input"].join(",");
function gi(e) {
  var t, n;
  return (n = (t = e == null ? void 0 : e.matches) == null ? void 0 : t.call(e, mi)) != null ? n : !1;
}
function yr(e, t = (n) => n) {
...
function wi(e, t) {
  return gt(wr(), t, { relativeTo: e });
}
function gt(e, t, { sorted: n = !0, relativeTo: r = null, skipElements: a = [] } = {}) {
  let i = Array.isArray(e) ? e.length > 0 ? e[0].ownerDocument : document : e.ownerDocument, s = Array.isArray(e) ? n ? yr(e) : e : wr(e);
  a.length > 0 && s.length > 1 && (s = s.filter((m) => !a.includes(m))), r = r ?? i.activeElement;
  let o = (() => {
    if (t & 5) return 1;
    if (t & 10) return -1;
...
function Er(e, t, n) {
  ...
  F(() => {
    ...
    return window.addEventListener(e, a, n), () => window.removeEventListener(e, a, n);
  }, [e, n]);
}
function Tr(e, t, n = !0) {
  let r = _(!1);
  ...
  function a(s, o) {
    ...
    return !bn(u, yn.Loose) && u.tabIndex !== -1 && s.preventDefault(), t(s, u);
  }
  let i = _(null);
  Ct("pointerdown", (s) => {
    var o, u;
    ...
    yi() || i.current && (a(s, () => i.current), i.current = null);
  }, !0), Ct("touchend", (s) => a(s, () => s.target instanceof HTMLElement ? s.target : null), !0), Er("blur", (s) => a(s, () => window.document.activeElement instanceof HTMLIFrameElement ? window.document.activeElement : null), !0);
}
function nt(...e) {
  return V(() => jt(...e), [...e]);
}
...
function xi({ container: e, accept: t, walk: n, enabled: r = !0 }) {
  let a = _(t), i = _(n);
  F(() => {
    ...
    let s = jt(e);
    if (!s) return;
    let o = a.current, u = i.current, f = Object.assign((d) => o(d), { acceptNode: o }), c = s.createTreeWalker(e, NodeFilter.SHOW_ELEMENT, f, !1);
...
var et = ((e) => (e[e.None = 0] = "None", e[e.RenderStrategy = 1] = "RenderStrategy", e[e.Static = 2] = "Static", e))(et || {}), Me = ((e) => (e[e.Unmount = 0] = "Unmount", e[e.Hidden = 1] = "Hidden", e))(Me || {});
function ne({ ourProps: e, theirProps: t, slot: n, defaultTag: r, features: a, visible: i = !0, name: s, mergeRefs: o }) {
  o = o ?? Ci;
  let u = Cr(t, e);
  if (i) return St(u, n, r, s, o);
  let f = a ?? 0;
  if (f & 2) {
    let { static: c = !1, ...d } = u;
    if (c) return St(d, n, r, s, o);
  }
  if (f & 1) {
    let { unmount: c = !0, ...d } = u;
    return Y(c ? 0 : 1, { 0() {
      ...
      return St({ ...d, hidden: !0, style: { display: "none" } }, n, r, s, o);
    } });
  }
  return St(u, n, r, s, o);
}
function St(e, t = {}, n, r, a) {
  let { as: i = n, children: s, refName: o = "ref", ...u } = Zt(e, ["unmount", "static"]), f = e.ref !== void 0 ? { [o]: e.ref } : {}, c = typeof s == "function" ? s(t) : s;
  "className" in u && u.className && typeof u.className == "function" && (u.className = u.className(t));
  let d = {};
  if (t) {
    let p = !1, m = [];
    for (let [w, g] of Object.entries(t)) typeof g == "boolean" && (p = !0), g === !0 && m.push(w);
    p && (d["data-headlessui-state"] = m.join(" "));
  }
  if (i === de && Object.keys(Zn(u)).length > 0) {
    if (!wa(c) || Array.isArray(c) && c.length > 1) throw new Error(['Passing props on "Fragment"!', "", `The current component <${r} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(u).map((g) => `  - ${g}`).join(`
`), "", "You can apply a few solutions:", ['Add an `as="..."` prop, to ensure that we render an actual element instead of a "Fragment".', "Render a single element as the child so that we can forward the props onto that element."].map((g) => `  - ${g}`).join(`
`)].join(`
`));
    let p = c.props, m = typeof (p == null ? void 0 : p.className) == "function" ? (...g) => Mt(p == null ? void 0 : p.className(...g), u.className) : Mt(p == null ? void 0 : p.className, u.className), w = m ? { className: m } : {};
    return va(c, Object.assign({}, Cr(c.props, Zn(Zt(u, ["ref"]))), d, f, { ref: a(c.ref, f.ref) }, w));
  }
  return ya(i, Object.assign({}, Zt(u, ["ref"]), i !== de && f, i !== de && d), c);
}
function Ci(...e) {
...
function Z(e) {
  var t;
  return Object.assign(ga(e), { displayName: (t = e.displayName) != null ? t : e.name });
}
function Zn(e) {
...
function Ii(e, t) {
  var n;
  let { features: r = 1, ...a } = e, i = { ref: t, "aria-hidden": (r & 2) === 2 ? !0 : (n = a["aria-hidden"]) != null ? n : void 0, hidden: (r & 4) === 4 ? !0 : void 0, style: { position: "fixed", top: 1, left: 1, width: 1, height: 0, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0", ...(r & 4) === 4 && (r & 2) !== 2 && { display: "none" } } };
  return ne({ ourProps: i, theirProps: a, slot: {}, defaultTag: Si, name: "Hidden" });
}
let fn = Z(Ii), Tn = ve(null);
...
Oi(() => {
  function e(t) {
    t.target instanceof HTMLElement && t.target !== document.body && _e[0] !== t.target && (_e.unshift(t.target), _e = _e.filter((n) => n != null && n.isConnected), _e.splice(10));
  }
...
let Li = "div";
var Rr = ((e) => (e[e.None = 1] = "None", e[e.InitialFocus = 2] = "InitialFocus", e[e.TabLock = 4] = "TabLock", e[e.FocusLock = 8] = "FocusLock", e[e.RestoreFocus = 16] = "RestoreFocus", e[e.All = 30] = "All", e))(Rr || {});
function _i(e, t) {
  let n = _(null), r = ae(n, t), { initialFocus: a, containers: i, features: s = 30, ...o } = e;
  tt() || (s = 1);
  let u = nt(n);
  Di({ ownerDocument: u }, !!(s & 16));
  let f = ki({ ownerDocument: u, container: n, initialFocus: a }, !!(s & 2));
  ji({ ownerDocument: u, container: n, containers: i, previousActiveElement: f }, !!(s & 8));
  let c = Ni(), d = P((g) => {
    let y = n.current;
    y && ((N) => N())(() => {
      Y(c.current, { [ht.Forwards]: () => {
        gt(y, Se.First, { skipElements: [g.relatedTarget] });
      }, [ht.Backwards]: () => {
        gt(y, Se.Last, { skipElements: [g.relatedTarget] });
      } });
    });
  }), p = wt(), m = _(!1), w = { ref: r, onKeyDown(g) {
    ...
    N instanceof HTMLElement && N.dataset.headlessuiFocusGuard !== "true" && (Nr(y, N) || (m.current ? gt(n.current, Y(c.current, { [ht.Forwards]: () => Se.Next, [ht.Backwards]: () => Se.Previous }) | Se.WrapAround, { relativeTo: g.target }) : g.target instanceof HTMLElement && De(g.target)));
  } };
  return O.createElement(O.Fragment, null, !!(s & 4) && O.createElement(fn, { as: "button", type: "button", "data-headlessui-focus-guard": !0, onFocus: d, features: $t.Focusable }), ne({ ourProps: w, theirProps: o, defaultTag: Li, name: "FocusTrap" }), !!(s & 4) && O.createElement(fn, { as: "button", type: "button", "data-headlessui-focus-guard": !0, onFocus: d, features: $t.Focusable }));
}
let Mi = Z(_i), dt = Object.assign(Mi, { features: Rr });
function $i(e = !0) {
  let t = _(_e.slice());
  return En(([n], [r]) => {
    r === !0 && n === !1 && kt(() => {
      t.current.splice(0);
    }), r === !1 && n === !0 && (t.current = _e.slice());
  }, [e, _e, t]), P(() => {
    var n;
    return (n = t.current.find((r) => r != null && r.isConnected)) != null ? n : null;
  });
}
function Di({ ownerDocument: e }, t) {
  let n = $i(t);
  En(() => {
...
function ki({ ownerDocument: e, container: t, initialFocus: n }, r) {
  let a = _(null), i = vt();
  return En(() => {
    if (!r) return;
    let s = t.current;
    s && kt(() => {
      ...
      n != null && n.current ? De(n.current) : gt(s, Se.First) === gr.Error && console.warn("There are no focusable elements inside the <FocusTrap />"), a.current = e == null ? void 0 : e.activeElement;
    });
  }, [r]), a;
}
function ji({ ownerDocument: e, container: t, containers: n, previousActiveElement: r }, a) {
  let i = vt();
  Or(e == null ? void 0 : e.defaultView, "focus", (s) => {
    ...
    if (!u) return;
    let f = s.target;
    f && f instanceof HTMLElement ? Nr(o, f) ? (r.current = f, De(f)) : (s.preventDefault(), s.stopPropagation(), De(u)) : De(r.current);
  }, !0);
}
function Nr(e, t) {
...
function pn(e) {
  return O.createElement(Lr.Provider, { value: e.force }, e.children);
}
function Ui(e) {
  let t = Fi(), n = oe(_r), r = nt(e), [a, i] = $(() => {
  ...
  return F(() => {
    a !== null && (r != null && r.body.contains(a) || r == null || r.body.appendChild(a));
  }, [a, r]), F(() => {
...
function Bi(e, t) {
  ...
  }), f ? !s || !o ? null : Va(ne({ ourProps: { ref: a }, theirProps: n, defaultTag: Hi, name: "Portal" }), o) : null;
}
let Ki = de, _r = ve(null);
function Wi(e, t) {
  let { target: n, ...r } = e, a = { ref: ae(t) };
  return O.createElement(_r.Provider, { value: n }, ne({ ourProps: a, theirProps: r, defaultTag: Ki, name: "Popover.Group" }));
}
let hn = ve(null);
function Xi() {
  let e = oe(hn), t = _([]), n = P((i) => (t.current.push(i), e && e.register(i), () => r(i))), r = P((i) => {
    let s = t.current.indexOf(i);
    s !== -1 && t.current.splice(s, 1), e && e.unregister(i);
  }), a = V(() => ({ register: n, unregister: r, portals: t }), [n, r, t]);
  return [t, V(() => function({ children: i }) {
    return O.createElement(hn.Provider, { value: a }, i);
  }, [a])];
}
let Vi = Z(Bi), Gi = Z(Wi), mn = Object.assign(Vi, { Group: Gi });
function Yi(e, t) {
  return e === t && (e !== 0 || 1 / e === 1 / t) || e !== e && t !== t;
}
const qi = typeof Object.is == "function" ? Object.is : Yi, { useState: zi, useEffect: Ji, useLayoutEffect: Zi, useDebugValue: Qi } = $e;
function es(e, t, n) {
  const r = t(), [{ inst: a }, i] = zi({ inst: { value: r, getSnapshot: t } });
  return Zi(() => {
    a.value = r, a.getSnapshot = t, Qt(a) && i({ inst: a });
  }, [e, r, t]), Ji(() => (Qt(a) && i({ inst: a }), e(() => {
    Qt(a) && i({ inst: a });
  })), [e]), Qi(r), r;
}
function Qt(e) {
...
const ns = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", rs = !ns, as = rs ? ts : es, is = "useSyncExternalStore" in $e ? ((e) => e.useSyncExternalStore)($e) : as;
function ss(e) {
  return is(e.subscribe, e.getSnapshot, e.getSnapshot);
}
function os(e, t) {
...
let He = os(() => /* @__PURE__ */ new Map(), { PUSH(e, t) {
  var n;
  ...
  let r = { doc: e, d: t, meta: ds(n) }, a = [us(), ls(), cs()];
  a.forEach(({ before: i }) => i == null ? void 0 : i(r)), a.forEach(({ after: i }) => i == null ? void 0 : i(r));
}, SCROLL_ALLOW({ d: e }) {
  e.dispose();
}, TEARDOWN({ doc: e }) {
  this.delete(e);
...
He.subscribe(() => {
  ...
  for (let n of e.values()) {
    ...
    (a && !r || !a && r) && He.dispatch(n.count > 0 ? "SCROLL_PREVENT" : "SCROLL_ALLOW", n), n.count === 0 && He.dispatch("TEARDOWN", n);
  }
});
function fs(e, t, n) {
  let r = ss(He), a = e ? r.get(e) : void 0, i = a ? a.count > 0 : !1;
  return q(() => {
...
function Qn(e, t = !0) {
  q(() => {
    ...
    let i = (n = ft.get(r)) != null ? n : 0;
    return ft.set(r, i + 1), i !== 0 || (en.set(r, { "aria-hidden": r.getAttribute("aria-hidden"), inert: r.inert }), r.setAttribute("aria-hidden", "true"), r.inert = !0), a;
  }, [e, t]);
}
function ps({ defaultContainers: e = [], portals: t, mainTreeNodeRef: n } = {}) {
  var r;
  let a = _((r = n == null ? void 0 : n.current) != null ? r : null), i = nt(a), s = P(() => {
    var o, u, f;
    let c = [];
    ...
    for (let d of (o = i == null ? void 0 : i.querySelectorAll("html > *, body > *")) != null ? o : []) d !== document.body && d !== document.head && d instanceof HTMLElement && d.id !== "headlessui-portal-root" && (d.contains(a.current) || d.contains((f = (u = a.current) == null ? void 0 : u.getRootNode()) == null ? void 0 : f.host) || c.some((p) => d.contains(p)) || c.push(d));
    return c;
  });
  return { resolveContainers: s, contains: P((o) => s().some((u) => u.contains(o))), mainTreeNodeRef: a, MainTreeNode: V(() => function() {
    return n != null ? null : O.createElement(fn, { features: $t.Hidden, ref: a });
  }, [a, n]) };
}
let xn = ve(() => {
});
...
function ms({ children: e, onUpdate: t, type: n, element: r, enabled: a }) {
  let i = hs(), s = P((...o) => {
    t == null || t(...o), i(...o);
  });
  return q(() => {
  ...
  }, [s, n, r, a]), O.createElement(xn.Provider, { value: s }, e);
}
let Mr = ve(null);
function $r() {
  let e = oe(Mr);
...
function gs() {
  ...
  return [e.length > 0 ? e.join(" ") : void 0, V(() => function(n) {
    let r = P((i) => (t((s) => [...s, i]), () => t((s) => {
      let o = s.slice(), u = o.indexOf(i);
      return u !== -1 && o.splice(u, 1), o;
    }))), a = V(() => ({ register: r, slot: n.slot, name: n.name, props: n.props }), [r, n.slot, n.name, n.props]);
    return O.createElement(Mr.Provider, { value: a }, n.children);
  }, [t])];
}
let ws = "p";
function vs(e, t) {
  let n = Re(), { id: r = `headlessui-description-${n}`, ...a } = e, i = $r(), s = ae(t);
  q(() => i.register(r), [r, i.register]);
  let o = { ref: s, ...i.props, id: r };
  return ne({ ourProps: o, theirProps: a, slot: i.slot || {}, defaultTag: ws, name: i.name || "Description" });
}
let ys = Z(vs), bs = Object.assign(ys, {});
var Es = ((e) => (e[e.Open = 0] = "Open", e[e.Closed = 1] = "Closed", e))(Es || {}), Ts = ((e) => (e[e.SetTitleId = 0] = "SetTitleId", e))(Ts || {});
let xs = { 0(e, t) {
...
function Cs(e, t, n = () => [document.body]) {
  fs(e, t, (r) => {
    var a;
...
function Ss(e, t) {
  return Y(t.type, xs, e, t);
}
let Is = "div", Os = et.RenderStrategy | et.Static;
function As(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-${n}`, open: a, onClose: i, initialFocus: s, role: o = "dialog", __demoMode: u = !1, ...f } = e, [c, d] = $(0), p = _(!1);
  o = function() {
  ...
  let m = Ft();
  a === void 0 && m !== null && (a = (m & J.Open) === J.Open);
  let w = _(null), g = ae(w, t), y = nt(w), N = e.hasOwnProperty("open") || m !== null, b = e.hasOwnProperty("onClose");
  if (!N && !b) throw new Error("You have to provide an `open` and an `onClose` prop to the `Dialog` component.");
  ...
  let A = a ? 0 : 1, [B, E] = ir(Ss, { titleId: null, descriptionId: null, panelRef: sn() }), T = P(() => i(!1)), I = P((U) => E({ type: 0, id: U })), D = tt() ? u ? !1 : A === 0 : !1, z = c > 1, le = oe(Dt) !== null, [ke, xe] = Xi(), Q = { get current() {
    var U;
    return (U = B.panelRef.current) != null ? U : w.current;
  } }, { resolveContainers: ue, mainTreeNodeRef: ce, MainTreeNode: Ke } = ps({ portals: ke, defaultContainers: [Q] }), ye = z ? "parent" : "leaf", je = m !== null ? (m & J.Closing) === J.Closing : !1, We = le || je ? !1 : D, Ce = H(() => {
    var U, pe;
    return (pe = Array.from((U = y == null ? void 0 : y.querySelectorAll("body > *")) != null ? U : []).find((ie) => ie.id === "headlessui-portal-root" ? !1 : ie.contains(ce.current) && ie instanceof HTMLElement)) != null ? pe : null;
  }, [ce]);
  Qn(Ce, We);
  let Ne = z ? !0 : D, me = H(() => {
    var U, pe;
    return (pe = Array.from((U = y == null ? void 0 : y.querySelectorAll("[data-headlessui-portal]")) != null ? U : []).find((ie) => ie.contains(ce.current) && ie instanceof HTMLElement)) != null ? pe : null;
  }, [ce]);
  Qn(me, Ne), Tr(ue, (U) => {
    U.preventDefault(), T();
  }, !(!D || z));
  let fe = !(z || A !== 0);
  Or(y == null ? void 0 : y.defaultView, "keydown", (U) => {
    fe && (U.defaultPrevented || U.key === G.Escape && (U.preventDefault(), U.stopPropagation(), T()));
  }), Cs(y, !(je || A !== 0 || le), ue), F(() => {
    if (A !== 0 || !w.current) return;
    let U = new ResizeObserver((pe) => {
      for (let ie of pe) {
        let Ye = ie.target.getBoundingClientRect();
        Ye.x === 0 && Ye.y === 0 && Ye.width === 0 && Ye.height === 0 && T();
      }
    });
    return U.observe(w.current), () => U.disconnect();
  }, [A, w, T]);
  let [at, it] = gs(), Xe = V(() => [{ dialogState: A, close: T, setTitleId: I }, B], [A, B, T, I]), Ve = V(() => ({ open: A === 0 }), [A]), Ge = { ref: g, id: r, role: o, "aria-modal": A === 0 ? !0 : void 0, "aria-labelledby": B.titleId, "aria-describedby": at };
  return O.createElement(ms, { type: "Dialog", enabled: A === 0, element: w, onUpdate: P((U, pe) => {
    pe === "Dialog" && Y(U, { [gn.Add]: () => d((ie) => ie + 1), [gn.Remove]: () => d((ie) => ie - 1) });
  }) }, O.createElement(pn, { force: !0 }, O.createElement(mn, null, O.createElement(Dt.Provider, { value: Xe }, O.createElement(mn.Group, { target: w }, O.createElement(pn, { force: !1 }, O.createElement(it, { slot: Ve, name: "Dialog.Description" }, O.createElement(dt, { initialFocus: s, containers: ue, features: D ? Y(ye, { parent: dt.features.RestoreFocus, leaf: dt.features.All & ~dt.features.FocusLock }) : dt.features.None }, O.createElement(xe, null, ne({ ourProps: Ge, theirProps: f, slot: Ve, defaultTag: Is, features: Os, visible: A === 0, name: "Dialog" }))))))))), O.createElement(Ke, null));
}
let Ps = "div";
function Rs(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-overlay-${n}`, ...a } = e, [{ dialogState: i, close: s }] = yt("Dialog.Overlay"), o = ae(t), u = P((c) => {
    if (c.target === c.currentTarget) {
      if (Ir(c.currentTarget)) return c.preventDefault();
      c.preventDefault(), c.stopPropagation(), s();
    }
  }), f = V(() => ({ open: i === 0 }), [i]);
  return ne({ ourProps: { ref: o, id: r, "aria-hidden": !0, onClick: u }, theirProps: a, slot: f, defaultTag: Ps, name: "Dialog.Overlay" });
}
let Ns = "div";
function Ls(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-backdrop-${n}`, ...a } = e, [{ dialogState: i }, s] = yt("Dialog.Backdrop"), o = ae(t);
  F(() => {
  ...
  let u = V(() => ({ open: i === 0 }), [i]);
  return O.createElement(pn, { force: !0 }, O.createElement(mn, null, ne({ ourProps: { ref: o, id: r, "aria-hidden": !0 }, theirProps: a, slot: u, defaultTag: Ns, name: "Dialog.Backdrop" })));
}
let _s = "div";
function Ms(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-panel-${n}`, ...a } = e, [{ dialogState: i }, s] = yt("Dialog.Panel"), o = ae(t, s.panelRef), u = V(() => ({ open: i === 0 }), [i]), f = P((c) => {
    c.stopPropagation();
  });
  return ne({ ourProps: { ref: o, id: r, onClick: f }, theirProps: a, slot: u, defaultTag: _s, name: "Dialog.Panel" });
}
let $s = "h2";
function Ds(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-title-${n}`, ...a } = e, [{ dialogState: i, setTitleId: s }] = yt("Dialog.Title"), o = ae(t);
  F(() => (s(r), () => s(null)), [r, s]);
  let u = V(() => ({ open: i === 0 }), [i]);
  return ne({ ourProps: { ref: o, id: r }, theirProps: a, slot: u, defaultTag: $s, name: "Dialog.Title" });
}
let ks = Z(As), js = Z(Ls), Fs = Z(Ms), Us = Z(Rs), Hs = Z(Ds), tn = Object.assign(ks, { Backdrop: js, Panel: Fs, Overlay: Us, Title: Hs, Description: bs }), er = /([\u2700-\u27BF]|[\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2011-\u26FF]|\uD83E[\uDD10-\uDDFF])/g;
function tr(e) {
  var t, n;
  let r = (t = e.innerText) != null ? t : "", a = e.cloneNode(!0);
  if (!(a instanceof HTMLElement)) return r;
  let i = !1;
  for (let o of a.querySelectorAll('[hidden],[aria-hidden],[role="img"]')) o.remove(), i = !0;
  let s = i ? (n = a.innerText) != null ? n : "" : r;
  ...
  if (n) {
    let r = n.split(" ").map((a) => {
      ...
      if (i) {
        ...
        return typeof s == "string" ? s.trim() : tr(i).trim();
      }
      return null;
    }).filter(Boolean);
...
function Ks(e) {
  ...
  return P(() => {
    ...
    let i = Bs(r).trim().toLowerCase();
    return t.current = a, n.current = i, i;
  });
}
var Ws = ((e) => (e[e.Open = 0] = "Open", e[e.Closed = 1] = "Closed", e))(Ws || {}), Xs = ((e) => (e[e.Pointer = 0] = "Pointer", e[e.Other = 1] = "Other", e))(Xs || {}), Vs = ((e) => (e[e.OpenMenu = 0] = "OpenMenu", e[e.CloseMenu = 1] = "CloseMenu", e[e.GoToItem = 2] = "GoToItem", e[e.Search = 3] = "Search", e[e.ClearSearch = 4] = "ClearSearch", e[e.RegisterItem = 5] = "RegisterItem", e[e.UnregisterItem = 6] = "UnregisterItem", e))(Vs || {});
function nn(e, t = (n) => n) {
  let n = e.activeItemIndex !== null ? e.items[e.activeItemIndex] : null, r = yr(t(e.items.slice()), (i) => i.dataRef.current.domRef.current), a = n ? r.indexOf(n) : null;
...
let Gs = { 1(e) {
  ...
  var n;
  let r = nn(e), a = Ri(t, { resolveItems: () => r.items, resolveActiveIndex: () => r.activeItemIndex, resolveId: (i) => i.id, resolveDisabled: (i) => i.dataRef.current.disabled });
  return { ...e, ...r, searchQuery: "", activeItemIndex: a, activationTrigger: (n = t.trigger) != null ? n : 1 };
}, 3: (e, t) => {
  let n = e.searchQuery !== "" ? 0 : 1, r = e.searchQuery + t.value.toLowerCase(), a = (e.activeItemIndex !== null ? e.items.slice(e.activeItemIndex + n).concat(e.items.slice(0, e.activeItemIndex + n)) : e.items).find((s) => {
    var o;
...
function Ys(e, t) {
  return Y(t.type, Gs, e, t);
}
let qs = de;
function zs(e, t) {
  let { __demoMode: n = !1, ...r } = e, a = ir(Ys, { __demoMode: n, menuState: n ? 0 : 1, buttonRef: sn(), itemsRef: sn(), items: [], searchQuery: "", activeItemIndex: null, activationTrigger: 1 }), [{ menuState: i, itemsRef: s, buttonRef: o }, u] = a, f = ae(t);
  Tr([o, s], (m, w) => {
    var g;
    u({ type: 1 }), bn(w, yn.Loose) || (m.preventDefault(), (g = o.current) == null || g.focus());
  }, i === 0);
  let c = P(() => {
    u({ type: 1 });
  }), d = V(() => ({ open: i === 0, close: c }), [i, c]), p = { ref: f };
  return O.createElement(Cn.Provider, { value: a }, O.createElement(Sr, { value: Y(i, { 0: J.Open, 1: J.Closed }) }, ne({ ourProps: p, theirProps: r, slot: d, defaultTag: qs, name: "Menu" })));
}
let Js = "button";
function Zs(e, t) {
  var n;
  let r = Re(), { id: a = `headlessui-menu-button-${r}`, ...i } = e, [s, o] = Ut("Menu.Button"), u = ae(s.buttonRef, t), f = wt(), c = P((g) => {
    switch (g.key) {
      case G.Space:
      case G.Enter:
      case G.ArrowDown:
        g.preventDefault(), g.stopPropagation(), o({ type: 0 }), f.nextFrame(() => o({ type: 2, focus: ge.First }));
        break;
      case G.ArrowUp:
        g.preventDefault(), g.stopPropagation(), o({ type: 0 }), f.nextFrame(() => o({ type: 2, focus: ge.Last }));
        break;
    }
  }), d = P((g) => {
    switch (g.key) {
    ...
    if (Ir(g.currentTarget)) return g.preventDefault();
    e.disabled || (s.menuState === 0 ? (o({ type: 1 }), f.nextFrame(() => {
      var y;
      return (y = s.buttonRef.current) == null ? void 0 : y.focus({ preventScroll: !0 });
    })) : (g.preventDefault(), o({ type: 0 })));
  }), m = V(() => ({ open: s.menuState === 0 }), [s]), w = { ref: u, id: a, type: bi(e, s.buttonRef), "aria-haspopup": "menu", "aria-controls": (n = s.itemsRef.current) == null ? void 0 : n.id, "aria-expanded": s.menuState === 0, onKeyDown: c, onKeyUp: d, onClick: p };
  return ne({ ourProps: w, theirProps: i, slot: m, defaultTag: Js, name: "Menu.Button" });
}
let Qs = "div", eo = et.RenderStrategy | et.Static;
function to(e, t) {
  var n, r;
  let a = Re(), { id: i = `headlessui-menu-items-${a}`, ...s } = e, [o, u] = Ut("Menu.Items"), f = ae(o.itemsRef, t), c = nt(o.itemsRef), d = wt(), p = Ft(), m = p !== null ? (p & J.Open) === J.Open : o.menuState === 0;
  F(() => {
    let b = o.itemsRef.current;
    b && o.menuState === 0 && b !== (c == null ? void 0 : c.activeElement) && b.focus({ preventScroll: !0 });
  }, [o.menuState, o.itemsRef, c]), xi({ container: o.itemsRef.current, enabled: o.menuState === 0, accept(b) {
  ...
  let w = P((b) => {
    ...
    switch (d.dispose(), b.key) {
      case G.Space:
        if (o.searchQuery !== "") return b.preventDefault(), b.stopPropagation(), u({ type: 3, value: b.key });
      case G.Enter:
        if (b.preventDefault(), b.stopPropagation(), u({ type: 1 }), o.activeItemIndex !== null) {
          let { dataRef: E } = o.items[o.activeItemIndex];
          (B = (A = E.current) == null ? void 0 : A.domRef.current) == null || B.click();
        }
        vr(o.buttonRef.current);
        break;
      case G.ArrowDown:
        return b.preventDefault(), b.stopPropagation(), u({ type: 2, focus: ge.Next });
      case G.ArrowUp:
        return b.preventDefault(), b.stopPropagation(), u({ type: 2, focus: ge.Previous });
      case G.Home:
      case G.PageUp:
        return b.preventDefault(), b.stopPropagation(), u({ type: 2, focus: ge.First });
      case G.End:
      case G.PageDown:
        return b.preventDefault(), b.stopPropagation(), u({ type: 2, focus: ge.Last });
      case G.Escape:
        b.preventDefault(), b.stopPropagation(), u({ type: 1 }), we().nextFrame(() => {
          var E;
          return (E = o.buttonRef.current) == null ? void 0 : E.focus({ preventScroll: !0 });
        });
        break;
      case G.Tab:
        b.preventDefault(), b.stopPropagation(), u({ type: 1 }), we().nextFrame(() => {
          wi(o.buttonRef.current, b.shiftKey ? Se.Previous : Se.Next);
        });
        break;
      default:
        b.key.length === 1 && (u({ type: 3, value: b.key }), d.setTimeout(() => u({ type: 4 }), 350));
        break;
    }
  }), g = P((b) => {
    switch (b.key) {
  ...
  }), y = V(() => ({ open: o.menuState === 0 }), [o]), N = { "aria-activedescendant": o.activeItemIndex === null || (n = o.items[o.activeItemIndex]) == null ? void 0 : n.id, "aria-labelledby": (r = o.buttonRef.current) == null ? void 0 : r.id, id: i, onKeyDown: w, onKeyUp: g, role: "menu", tabIndex: 0, ref: f };
  return ne({ ourProps: N, theirProps: s, slot: y, defaultTag: Qs, features: eo, visible: m, name: "Menu.Items" });
}
let no = de;
function ro(e, t) {
  let n = Re(), { id: r = `headlessui-menu-item-${n}`, disabled: a = !1, ...i } = e, [s, o] = Ut("Menu.Item"), u = s.activeItemIndex !== null ? s.items[s.activeItemIndex].id === r : !1, f = _(null), c = ae(t, f);
  q(() => {
    if (s.__demoMode || s.menuState !== 0 || !u || s.activationTrigger === 0) return;
    let E = we();
    return E.requestAnimationFrame(() => {
      var T, I;
      (I = (T = f.current) == null ? void 0 : T.scrollIntoView) == null || I.call(T, { block: "nearest" });
    }), E.dispose;
  }, [s.__demoMode, f, u, s.menuState, s.activationTrigger, s.activeItemIndex]);
  let d = Ks(f), p = _({ disabled: a, domRef: f, get textValue() {
    return d();
  } });
  q(() => {
    p.current.disabled = a;
  }, [p, a]), q(() => (o({ type: 5, id: r, dataRef: p }), () => o({ type: 6, id: r })), [p, r]);
  let m = P(() => {
    o({ type: 1 });
  }), w = P((E) => {
    if (a) return E.preventDefault();
    o({ type: 1 }), vr(s.buttonRef.current);
  }), g = P(() => {
    if (a) return o({ type: 2, focus: ge.Nothing });
    o({ type: 2, focus: ge.Specific, id: r });
  }), y = Ti(), N = P((E) => y.update(E)), b = P((E) => {
    y.wasMoved(E) && (a || u || o({ type: 2, focus: ge.Specific, id: r, trigger: 0 }));
  }), A = P((E) => {
    y.wasMoved(E) && (a || u && o({ type: 2, focus: ge.Nothing }));
  }), B = V(() => ({ active: u, disabled: a, close: m }), [u, a, m]);
  return ne({ ourProps: { id: r, ref: c, role: "menuitem", tabIndex: a === !0 ? void 0 : -1, "aria-disabled": a === !0 ? !0 : void 0, disabled: void 0, onClick: w, onFocus: g, onPointerEnter: N, onMouseEnter: N, onPointerMove: b, onMouseMove: b, onPointerLeave: A, onMouseLeave: A }, theirProps: i, slot: B, defaultTag: no, name: "Menu.Item" });
}
let ao = Z(zs), io = Z(Zs), so = Z(to), oo = Z(ro), Ze = Object.assign(ao, { Button: io, Items: so, Item: oo });
function lo(e = 0) {
  let [t, n] = $(e), r = vt(), a = H((u) => {
    r.current && n((f) => f | u);
  }, [t, r]), i = H((u) => !!(t & u), [t]), s = H((u) => {
    r.current && n((f) => f & ~u);
  }, [n, r]), o = H((u) => {
    r.current && n((f) => f ^ u);
  }, [n]);
  return { flags: t, addFlag: a, hasFlag: i, removeFlag: s, toggleFlag: o };
}
function uo(e) {
  let t = { called: !1 };
  return (...n) => {
...
function co(e, t) {
  ...
  let { transitionDuration: r, transitionDelay: a } = getComputedStyle(e), [i, s] = [r, a].map((u) => {
...
function fo(e, t, n, r) {
  let a = n ? "enter" : "leave", i = we(), s = r !== void 0 ? uo(r) : () => {
  };
  a === "enter" && (e.removeAttribute("hidden"), e.style.display = "");
  let o = Y(a, { enter: () => t.enter, leave: () => t.leave }), u = Y(a, { enter: () => t.enterTo, leave: () => t.leaveTo }), f = Y(a, { enter: () => t.enterFrom, leave: () => t.leaveFrom });
  return an(e, ...t.base, ...t.enter, ...t.enterTo, ...t.enterFrom, ...t.leave, ...t.leaveFrom, ...t.leaveTo, ...t.entered), rn(e, ...t.base, ...o, ...f), i.nextFrame(() => {
    an(e, ...t.base, ...o, ...f), rn(e, ...t.base, ...o, ...u), co(e, () => (an(e, ...t.base, ...o), rn(e, ...t.base, ...t.entered), s()));
  }), i.dispose;
}
function po({ immediate: e, container: t, direction: n, classes: r, onStart: a, onStop: i }) {
  let s = vt(), o = wt(), u = Ae(n);
  q(() => {
    e && (u.current = "enter");
  }, [e]), q(() => {
    let f = we();
    o.add(f.dispose);
    let c = t.current;
    if (c && u.current !== "idle" && s.current) return f.dispose(), a.current(u.current), f.add(fo(c, r.current, u.current === "enter", () => {
      f.dispose(), i.current(u.current);
    })), f.dispose;
  }, [n]);
}
function Le(e = "") {
...
var ho = ((e) => (e.Visible = "visible", e.Hidden = "hidden", e))(ho || {});
function mo() {
  let e = oe(Ht);
...
function Dr(e, t) {
  let n = Ae(e), r = _([]), a = vt(), i = wt(), s = P((m, w = Me.Hidden) => {
    let g = r.current.findIndex(({ el: y }) => y === m);
    g !== -1 && (Y(w, { [Me.Unmount]() {
      ...
      var y;
      !Kt(r) && a.current && ((y = n.current) == null || y.call(n));
    }));
  }), o = P((m) => {
    let w = r.current.find(({ el: g }) => g === m);
    return w ? w.state !== "visible" && (w.state = "visible") : r.current.push({ el: m, state: "visible" }), () => s(m, Me.Unmount);
  }), u = _([]), f = _(Promise.resolve()), c = _({ enter: [], leave: [], idle: [] }), d = P((m, w, g) => {
    u.current.splice(0), t && (t.chains.current[w] = t.chains.current[w].filter(([y]) => y !== m)), t == null || t.chains.current[w].push([m, new Promise((y) => {
      u.current.push(y);
    })]), t == null || t.chains.current[w].push([m, new Promise((y) => {
      Promise.all(c.current[w].map(([N, b]) => b)).then(() => y());
    })]), w === "enter" ? f.current = f.current.then(() => t == null ? void 0 : t.wait.current).then(() => g(w)) : g(w);
  }), p = P((m, w, g) => {
    Promise.all(c.current[w].splice(0).map(([y, N]) => N)).then(() => {
      var y;
...
let vo = ["beforeEnter", "afterEnter", "beforeLeave", "afterLeave"];
function nr(e) {
  var t;
  let n = {};
  for (let r of vo) n[r] = (t = e[r]) != null ? t : wo;
  return n;
}
function yo(e) {
  let t = _(nr(e));
...
let bo = "div", kr = et.RenderStrategy;
function Eo(e, t) {
  var n, r;
  let { beforeEnter: a, afterEnter: i, beforeLeave: s, afterLeave: o, enter: u, enterFrom: f, enterTo: c, entered: d, leave: p, leaveFrom: m, leaveTo: w, ...g } = e, y = _(null), N = ae(y, t), b = (n = g.unmount) == null || n ? Me.Unmount : Me.Hidden, { show: A, appear: B, initial: E } = mo(), [T, I] = $(A ? "visible" : "hidden"), D = go(), { register: z, unregister: le } = D;
  F(() => z(y), [z, y]), F(() => {
    if (b === Me.Hidden && y.current) {
      if (A && T !== "visible") {
        I("visible");
        return;
      }
      return Y(T, { hidden: () => le(y), visible: () => z(y) });
    }
  }, [T, y, z, le, A, b]);
  let ke = Ae({ base: Le(g.className), enter: Le(u), enterFrom: Le(f), enterTo: Le(c), entered: Le(d), leave: Le(p), leaveFrom: Le(m), leaveTo: Le(w) }), xe = yo({ beforeEnter: a, afterEnter: i, beforeLeave: s, afterLeave: o }), Q = tt();
  F(() => {
    if (Q && T === "visible" && y.current === null) throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [y, T, Q]);
  let ue = E && !B, ce = B && A && E, Ke = !Q || ue ? "idle" : A ? "enter" : "leave", ye = lo(0), je = P((fe) => Y(fe, { enter: () => {
    ye.addFlag(J.Opening), xe.current.beforeEnter();
  }, leave: () => {
    ye.addFlag(J.Closing), xe.current.beforeLeave();
  }, idle: () => {
  } })), We = P((fe) => Y(fe, { enter: () => {
    ye.removeFlag(J.Opening), xe.current.afterEnter();
  }, leave: () => {
    ye.removeFlag(J.Closing), xe.current.afterLeave();
  }, idle: () => {
  } })), Ce = Dr(() => {
    I("hidden"), le(y);
  }, D), Ne = _(!1);
  po({ immediate: ce, container: y, classes: ke, direction: Ke, onStart: Ae((fe) => {
    Ne.current = !0, Ce.onStart(y, fe, je);
  }), onStop: Ae((fe) => {
    Ne.current = !1, Ce.onStop(y, fe, We), fe === "leave" && !Kt(Ce) && (I("hidden"), le(y));
  }) });
  let me = g, rt = { ref: N };
  return ce ? me = { ...me, className: Mt(g.className, ...ke.current.enter, ...ke.current.enterFrom) } : Ne.current && (me.className = Mt(g.className, (r = y.current) == null ? void 0 : r.className), me.className === "" && delete me.className), O.createElement(Bt.Provider, { value: Ce }, O.createElement(Sr, { value: Y(T, { visible: J.Open, hidden: J.Closed }) | ye.flags }, ne({ ourProps: rt, theirProps: me, defaultTag: bo, features: kr, visible: T === "visible", name: "Transition.Child" })));
}
function To(e, t) {
  let { show: n, appear: r = !1, unmount: a = !0, ...i } = e, s = _(null), o = ae(s, t);
  tt();
  let u = Ft();
  if (n === void 0 && u !== null && (n = (u & J.Open) === J.Open), ![!0, !1].includes(n)) throw new Error("A <Transition /> is used but it is missing a `show={true | false}` prop.");
  let [f, c] = $(n ? "visible" : "hidden"), d = Dr(() => {
    c("hidden");
  }), [p, m] = $(!0), w = _([n]);
  q(() => {
    p !== !1 && w.current[w.current.length - 1] !== n && (w.current.push(n), m(!1));
  }, [w, n]);
  let g = V(() => ({ show: n, appear: r, initial: p }), [n, r, p]);
  F(() => {
    if (n) c("visible");
    else if (!Kt(d)) c("hidden");
    else {
      let A = s.current;
      if (!A) return;
...
function Po({
  ...
  return /* @__PURE__ */ x.jsx(
    Ze,
    {
      ...
      children: ({ open: s }) => /* @__PURE__ */ x.jsxs(x.Fragment, { children: [
        /* @__PURE__ */ x.jsxs(Ze.Button, { children: [
          /* @__PURE__ */ x.jsx("div", { className: "wallet-identifier-container", children: /* @__PURE__ */ x.jsx(
            "img",
            {
              src: Oo[i],
              alt: `${i} is connected`
          ...
          /* @__PURE__ */ x.jsxs("section", { className: "address-container", children: [
            /* @__PURE__ */ x.jsx("p", { className: "address", children: vn(e) }),
            /* @__PURE__ */ x.jsxs("section", { className: "network-container", children: [
              /* @__PURE__ */ x.jsx("div", { className: "status-indicator" }),
              /* @__PURE__ */ x.jsx("p", { className: "network", children: Ao[t] ?? t })
            ] })
          ] }),
          /* @__PURE__ */ x.jsx(
            "img",
        ...
        /* @__PURE__ */ x.jsx(
          Nt,
          {
            ...
            children: /* @__PURE__ */ x.jsxs(Ze.Items, { className: "ord-wallet-connection-dropdown", children: [
              /* @__PURE__ */ x.jsxs(
                Ze.Item,
                {
                  as: "button",
                  ...
                  children: [
                    /* @__PURE__ */ x.jsx("span", { className: "label", children: "View profile" }),
                    /* @__PURE__ */ x.jsx("span", { className: "value", children: vn(e) })
                  ]
                }
              ),
              /* @__PURE__ */ x.jsx(
                Ze.Item,
                {
                  ...
                  children: /* @__PURE__ */ x.jsx("span", { className: "change-wallet-label", children: "Change wallet" })
                }
              ),
              /* @__PURE__ */ x.jsx("hr", { className: "horizontal-separator" }),
              /* @__PURE__ */ x.jsxs(
                Ze.Item,
                {
                  as: "button",
                  ...
                  children: [
                    /* @__PURE__ */ x.jsx("span", { className: "label", children: "Disconnect wallet" }),
                    /* @__PURE__ */ x.jsx("img", { src: Io, className: "logout-icon", alt: "logout" })
                  ]
                }
              )
            ] })
...
function pt({
  ...
  const { wallet: o, address: u } = Te(), [{ connectedWallet: f, connectedAddress: c }] = $({
    connectedWallet: o,
    connectedAddress: u
  }), [d, p] = $(!1), m = Do[e], w = H(async () => {
  ...
  return /* @__PURE__ */ x.jsxs(
    "button",
    {
      ...
      disabled: i,
      children: [
        /* @__PURE__ */ x.jsxs("div", { className: "wallie-flex wallie-flex-row wallie-space-x-2", children: [
          /* @__PURE__ */ x.jsx("img", { className: "wallie-w-5 md:wallie-w-8", src: r, alt: "" }),
          /* @__PURE__ */ x.jsx("span", { className: "wallie-text-lg wallie-block wallie-font-medium", children: m }),
          /* @__PURE__ */ x.jsx(
            "span",
            {
        ...
        f === e && c.ordinals ? /* @__PURE__ */ x.jsx("div", { className: "wallie-flex wallie-flex-row wallie-ml-auto", children: /* @__PURE__ */ x.jsx("span", { className: "wallie-text-sm wallie-font-medium wallie-pr-3", children: vn(c.ordinals) }) }) : null,
        d && /* @__PURE__ */ x.jsx(
          "img",
          {
            src: $o,
...
const rr = {
  [C.OKX]: "https://www.okx.com/web3",
  [C.XVERSE]: "https://www.xverse.app/download",
  [C.LEATHER]: "https://leather.io/install-extension",
  [C.MAGICEDEN]: "https://wallet.magiceden.io/",
  [C.UNISAT]: "https://unisat.io/download"
  // their www subdomain doesn't work
}, ko = {
  [C.XVERSE]: "xverse://browser?url=",
  [C.UNISAT]: "",
  [C.MAGICEDEN]: "",
  [C.LEATHER]: "",
  [C.OKX]: ""
...
function jo({
  ...
  const {
      ...
      if (T instanceof ka)
        if (w) {
          ...
          if (I) {
            let z;
            const le = () => {
              document.hidden && (clearTimeout(z), document.removeEventListener(
                "visibilitychange",
                le
              ));
            };
            document.addEventListener(
              "visibilitychange",
              le
            ), window.location.href = I, z = window.setTimeout(() => {
              document.removeEventListener(
                "visibilitychange",
                le
              ), window.location.href = D, m(T.message ?? T.toString()), d();
            }, 2e3);
          } else
            window.location.href = D, m(T.message ?? T.toString()), d();
        } else
    ...
    try {
      ...
      const T = E.find(
        (D) => D.format === "segwit" || D.format === "p2sh-p2wpkh"
      );
      if (!T)
        throw new Error(
    ...
    async ({ readOnly: E } = {}) => {
      try {
        ...
        return n({
          ...
          ordinals: I.publicKey,
          payments: I.publicKey
        }), a(C.UNISAT), s({
          ordinals: I.format,
          payments: I.format
        }), t(), !0;
      } catch (T) {
        return g(C.UNISAT, T), !1;
      }
    },
    [
      t,
    ...
    try {
      ...
      const T = E.find(
        (D) => D.format === "p2sh-p2wpkh" || D.format === "segwit"
      );
      if (!T)
        throw new Error(
    ...
    try {
      ...
      const E = await Aa(r);
      if (!E || E.length < 1)
        throw d(), new Error("OKX via Ordit returned no addresses.");
      const T = E[0];
      return n({
        ordinals: T.address,
        payments: T.address
  ...
  return F(() => {
    ...
    return f && c && u && (async () => {
      ...
      if (E) {
        ...
        T = await N({ readOnly: !0 }), E && T && window.unisat.addListener("accountsChanged", I);
      }
    })(), () => {
      E = !1, T && window.unisat.removeListener("accountsChanged", I);
    };
  }, [
    o,
    N,
    ...
    c,
    u
  ]), /* @__PURE__ */ x.jsx(Nt.Root, { appear: !0, show: e, as: de, children: /* @__PURE__ */ x.jsxs(
    tn,
    {
      as: "div",
      ...
      children: [
        /* @__PURE__ */ x.jsx(
          Nt.Child,
          {
            ...
            children: /* @__PURE__ */ x.jsx("div", { className: "wallie-fixed wallie-inset-0 wallie-bg-black/90 md:wallie-bg-black/80 wallie-transition-opacity" })
          }
        ),
        /* @__PURE__ */ x.jsx("section", { className: "wallie-fixed wallie-inset-0 wallie-z-[200] wallie-overflow-y-auto", children: /* @__PURE__ */ x.jsx("div", { className: "wallie-flex wallie-min-h-full wallie-w-full md:wallie-w-96 wallie-mx-auto wallie-items-center wallie-justify-center wallie-p-4 wallie-text-left sm:wallie-items-center sm:wallie-p-0", children: /* @__PURE__ */ x.jsx(
          Nt.Child,
          {
            as: de,
            enter: "wallie-ease-out wallie-duration-300",
            ...
            children: /* @__PURE__ */ x.jsxs(
              tn.Panel,
              {
                ...
                children: [
                  /* @__PURE__ */ x.jsxs("section", { className: "wallie-flex wallie-flex-row", children: [
                    /* @__PURE__ */ x.jsx(
                      tn.Title,
                      {
                        as: "h3",
                  ...
                  /* @__PURE__ */ x.jsx("p", { className: "wallie-text-ord-light-blue-400 wallie-font-medium wallie-py-3", children: "Choose a wallet below to connect and continue" }),
                  p && /* @__PURE__ */ x.jsx("p", { className: "wallie-text-ord-alert wallie-pb-4", children: p }),
                  /* @__PURE__ */ x.jsx("section", { className: "wallie-w-full", children: /* @__PURE__ */ x.jsxs("section", { className: "wallie-w-full wallie-flex wallie-flex-col wallie-space-y-4 wallie-relative", children: [
                    !w && /* @__PURE__ */ x.jsx(
                      pt,
                      {
                        wallet: C.LEATHER,
                    ...
                    !w || w && r === mt.MAINNET ? /* @__PURE__ */ x.jsx(
                      pt,
                      {
                        wallet: C.OKX,
                        subtitle: "",
                    ...
                    !w && // TODO: remove this once unisat supported on mobile devices
                    /* @__PURE__ */ x.jsx(
                      pt,
                      {
                        wallet: C.UNISAT,
...
function wl({
  ...
  hideConnectButton: n,
  onViewProfile: r,
  onChangeWalletClick: a,
  onDisconnectWalletClick: i
}) {
  const {
    address: s,
    disconnectWallet: o,
    ...
    openModal: c,
    closeModal: d
  } = Te(), p = ri(), m = () => n ? null : s != null && s.ordinals ? /* @__PURE__ */ x.jsx(
    Po,
    {
      address: s.ordinals,
      network: u,
  ...
  return /* @__PURE__ */ x.jsxs(x.Fragment, { children: [
    m(),
    p ? /* @__PURE__ */ x.jsx(jo, { isOpen: f, closeModal: d }) : null
  ] });
}
class Fo {
...
class It {
  ...
  static parseInscription(t, { decodeMetadata: n }) {
    return {
      ...t,
      meta: n && t.meta ? ja(t.meta) : t.meta
    };
  }
  /**
   * Parses inscriptions.
  ...
  static segregateUTXOsBySpendStatus({
    ...
    const { spendableUTXOs: n, unspendableUTXOs: r } = t.reduce(
      (a, i) => (i.safeToSpend ? a.spendableUTXOs.push(i) : a.unspendableUTXOs.push(i), a),
      {
        spendableUTXOs: [],
        unspendableUTXOs: []
      }
...
class Pt {
  ...
  async call(t, n, r) {
    ...
    throw new te("Internal Server Error");
  }
}
const ee = {
  get id() {
  ...
  mainnet: new Pt(At(Ot.apis.mainnet.batter)),
  testnet: new Pt(At(Ot.apis.testnet.batter)),
  signet: new Pt(At(Ot.apis.signet.batter)),
  regtest: new Pt(At(Ot.apis.regtest.batter))
};
class bt extends Fo {
  constructor({ network: t }) {
    super({ network: t });
  ...
  async getBalance({ address: t }) {
    if (!t)
      throw new te("Invalid request");
    return ee[this.network].call(
      "Address.GetBalance",
      { address: t },
      ee.id
    );
  ...
  async getInscription({
    ...
    if (!t)
      throw new te("Invalid request");
    const r = Hn(t), a = await ee[this.network].call(
      "Ordinals.GetInscription",
      { id: r },
      ee.id
    );
    return It.parseInscription(a, { decodeMetadata: n });
  }
  ...
  async getInscriptions({
    ...
    let c = [], d = f;
    do {
      const { inscriptions: p, pagination: m } = await ee[this.network].call(
        "Ordinals.GetInscriptions",
        {
          filter: { creator: t, owner: n, mimeType: r, mimeSubType: a, outpoint: i },
          sort: { number: o },
  ...
  async getTransaction({
    ...
    if (!t)
      throw new te("Invalid request");
    const s = await ee[this.network].call(
    ...
    return s.vout = s.vout.map((o) => ({
      ...o,
      inscriptions: It.parseInscriptions(o.inscriptions, {
        decodeMetadata: i
      })
    })), {
      tx: s,
  ...
  async getUnspents({
    ...
    let o = [], u = s;
    do {
      const { unspents: f, pagination: c } = await ee[this.network].call(
        "Address.GetUnspents",
        {
          address: t,
          options: {
    ...
    return It.segregateUTXOsBySpendStatus({ utxos: o });
  }
  async relay({ hex: t, maxFeeRate: n, validate: r = !0 }) {
    if (!t)
      throw new te("Invalid request");
    if (n && (n < 0 || Number.isNaN(n)))
      throw new te("Invalid max fee rate");
    return ee[this.network].call(
      "Transactions.Relay",
...
function vl() {
  const { network: e, publicKey: t, format: n } = Te(), [r, a] = $(null), [i, s] = $(!1);
  return { getBalance: H(async () => {
    s(!0);
    try {
      if (a(null), !n || !n.payments || !t || !t.payments)
        throw new Error("No wallet is connected");
      const { address: u } = Fa(
        t.payments,
        e,
        Ua[n.payments]
      )[0], c = await new bt({ network: e }).getBalance({ address: u }), d = Number(
        new Kn(c).multipliedBy(1e8).toFixed(0, Kn.ROUND_HALF_DOWN)
      );
      return s(!1), d;
    } catch (u) {
      throw a(u.message), s(!1), u;
    }
  }, [n, e, t]), error: r, loading: i };
}
async function Sn({
  address: e,
  wallet: t,
  ...
  var u, f;
  if ((u = a == null ? void 0 : a.signingIndexes) != null && u.length && ((f = a == null ? void 0 : a.inputsToSign) != null && f.length))
    throw new Error("Cannot have both indexes and inputs to sign together");
  const i = (a == null ? void 0 : a.finalize) ?? !0, s = (a == null ? void 0 : a.extractTx) ?? !0, o = () => r.data.inputs.map((c, d) => d);
  if (t === C.MAGICEDEN)
    return await Sa(r, {
      network: n,
      inputsToSign: (a == null ? void 0 : a.inputsToSign) ?? [
        {
          address: e,
          signingIndexes: (a == null ? void 0 : a.signingIndexes) ?? o(),
          sigHash: a == null ? void 0 : a.sigHash
        }
      ],
      finalize: i,
      extractTx: s
  ...
  if (t === C.LEATHER)
    return await Ea(r, {
      ...
      finalize: i,
      extractTx: s,
      allowedSighash: a != null && a.sigHash ? [a == null ? void 0 : a.sigHash] : [],
      signAtIndexes: (a == null ? void 0 : a.signingIndexes) ?? o()
      // If signingIndexes is not provided, just sign everything
    });
  if (t === C.OKX)
    return await Pa(r, {
...
function ar(e) {
  switch (e) {
    ...
    default:
      throw new te("Invalid type");
  }
}
class Xo {
  constructor({ feeRate: t, network: n, psbt: r, witness: a }) {
    /**
     * Fee in satoshis
     */
    j(this, "fee", 0);
    ...
    if (t < 0 || !Number.isSafeInteger(t))
      throw new te("Invalid feeRate");
    this.feeRate = t, this.network = n, this.witness = a || [], this.psbt = r || new _t({ network: Lt(this.network) });
  }
  get data() {
    return {
      fee: this.fee,
   ...
   */
  calculateNetworkFee() {
    if (this.fee = this.calculateVirtualSize() * this.feeRate, this.fee > Ha)
      throw new te("Error while calculating fees");
    return this.fee;
  }
  getInputAndOutputScriptTypes() {
    const { inputs: t } = this.psbt.data, n = this.psbt.txOutputs;
    if (t.length === 0)
      throw new te("PSBT must have at least one input");
    if (n.length === 0)
      throw new te("PSBT must have at least one output");
    return {
      inputTypes: t.map((r) => {
        const a = r.witnessUtxo && r.witnessUtxo.script ? r.witnessUtxo.script : null;
        if (!a)
          throw new te("Invalid script");
        return Bn(a, this.network).format;
      }),
      outputTypes: n.map(
  ...
  calculateScriptWitnessSize() {
    ...
    return t.includes("taproot") && ((n = this.witness) != null && n.length) ? this.witness.reduce((r, a) => r + a.byteLength, 0) : 0;
  }
  getBaseSize() {
    var u, f;
    const { inputTypes: t, outputTypes: n } = this.getInputAndOutputScriptTypes(), r = 2, a = t.reduce(
      (c, d) => {
        const { input: p, witness: m } = ar(d);
      ...
      const { output: p } = ar(d);
      return c + p;
    }, 0), s = a.witness + ((u = this.witness) != null && u.length ? this.calculateScriptWitnessSize() : 0);
    let o = 0;
    return (f = this.witness) != null && f.length ? o = s : s > 0 && (o = r + s), {
      baseSize: a.input + Wo + i,
      witnessSize: o
    };
  }
...
function Yo({
  ...
  const a = or(Be.from(t, "hex"), "p2sh", n);
  if (!a || !a.output || !a.redeem)
    throw new Error("Unable to process P2SH input");
  return {
    type: "p2sh-p2wpkh",
    hash: e.txid,
    index: e.n,
    redeemScript: a.redeem.output,
    witnessUtxo: {
      script: Be.from(e.scriptPubKey.hex, "hex"),
      value: e.sats
    },
...
async function qo({
  ...
  const { rawTx: i } = await a.getTransaction({
    txId: e.txid,
    hex: !0
  });
  if (!i)
    throw new Error("Unable to process legacy input");
  const s = or(Be.from(r, "hex"), "p2pkh", n);
  return {
    type: "legacy",
    hash: e.txid,
    index: e.n,
    nonWitnessUtxo: i == null ? void 0 : i.toBuffer(),
    witnessUtxo: {
      script: s.output,
      value: e.sats
    },
...
async function zo({
  ...
  switch (e.scriptPubKey.type) {
    ...
    case "witness_v0_keyhash":
      return Go({ utxo: e, sighashType: r });
    case "scripthash":
      return Yo({ utxo: e, pubKey: t, network: n, sighashType: r });
    case "pubkeyhash":
      return qo({
        utxo: e,
        sighashType: r,
...
class Wr extends Xo {
  constructor({
    ...
    this.address = n, this.changeAddress = r, this.datasource = a || new bt({ network: this.network }), this.outputs = u, this.publicKey = o, this.autoAdjustment = f, this.instantTradeMode = c, this.psbt = new _t({ network: Lt(s) });
  }
  get data() {
    return {
      fee: this.fee,
   ...
   */
  get xKey() {
    return sr(Be.from(this.publicKey, "hex")).toString("hex");
  }
  get inputsToSign() {
    const n = this.instantTradeMode && !this.autoAdjustment;
    return this.psbt.txInputs.reduce(
      (r, a, i) => ((!this.instantTradeMode || this.instantTradeMode && i !== Wa) && (r.signingIndexes = r.signingIndexes.concat(i)), n && (r.sigHash = // eslint-disable-next-line no-bitwise
  ...
  initPSBT() {
    this.psbt = new _t({ network: Lt(this.network) }), this.psbt.setMaximumFeeRate(this.feeRate);
  }
  getInputSequence() {
  ...
  addInputs() {
    ...
    this.inputs.forEach((a, i) => {
      ...
      this.psbt.txInputs.map((u) => {
        ...
        lt(a.hash, a.index)
      ) || (this.psbt.addInput(a), this.psbt.setInputSequence(
        s ? i + 1 : i,
        this.getInputSequence()
      ));
    }), this.injectableInputs.forEach((a) => {
      r.includes(a.injectionIndex) || (this.injectInput(a), r.push(a.injectionIndex));
    });
  }
  addOutputs() {
    const n = this.injectableOutputs.map((a) => a.injectionIndex), r = [];
    this.outputs.forEach((a, i) => {
      if (n.includes(i)) {
    ...
    }), this.injectableOutputs.forEach((a) => {
      r.includes(a.injectionIndex) || (this.injectOutput(a), r.push(a.injectionIndex));
  ...
  async retrieveUTXOs(n, r) {
    if (!this.autoAdjustment && !n)
      return;
    const a = r && r > 0 ? r : this.getUTXOAmountToRequestFromChangeAmount();
    if (r && this.getRetrievedUTXOsValue() >= r || a <= 0)
      return;
    const i = await this.datasource.getSpendables({
  ...
  async retrieveSelectedUTXOs(n, r) {
    ...
    const a = this.utxos.find((i) => i.sats >= r);
    return this.utxos = a ? [a] : [], this.utxos;
  }
  /**
  ...
  async prepareInputs() {
    if (!this.autoAdjustment)
      return;
    const n = [];
    this.utxos.forEach((a) => {
      if (this.usedUTXOs.includes(lt(a.txid, a.n)))
        return;
      this.inputAmount += a.sats;
      const i = zo({
        utxo: a,
...
function yl() {
  const { wallet: e, network: t, address: n, publicKey: r } = Te(), [a, i] = $(null), [s, o] = $(!1);
  return { send: H(
    async (f, c, d, p = !0) => {
      o(!0);
      try {
        if (i(null), !n || !n.payments || !r || !r.payments || !e)
          throw new Error("No wallet is connected");
        const m = new Wr({
          address: n.payments,
          feeRate: d,
        ...
        if (p) {
          const y = await new bt({ network: t }).relay({ hex: w.hex });
          return o(!1), y;
        }
        return o(!1), w.hex;
      } catch (m) {
        return i(m.message), o(!1), null;
      }
    },
    [n, t, r, e]
  ), error: a, loading: s };
    ...
    async (f) => {
      ...
      try {
        ...
        if (e === "magiceden") {
          const c = await Ia();
          let d = null;
          return d = await new Promise((p, m) => {
            Ya({
              payload: {
                network: {
                  type: t === "mainnet" ? Xn.Mainnet : Xn.Testnet
                },
                message: "Sign Transaction",
                recipients: f.map((w) => ({
                  address: w.address,
                  amountSats: BigInt(w.satoshis)
                })),
              ...
              onCancel: () => {
                m(new Error("Transaction canceled"));
              }
            });
          }), o(!1), d;
        }
        if (e === "xverse") {
          ...
          try {
            ...
            if (d.status === "success")
              c = d.result.txid;
            else throw d.error.code === za.USER_REJECTION ? new Error("Transaction canceled") : new Error("Transaction canceled");
          } catch {
        ...
        if (e === "unisat") {
          let c = "";
          return c = await window.unisat.sendBitcoin(
            f[0].address,
            f[0].satoshis,
            {}
          ), o(!1), c;
        ...
        if (e === "okx") {
          let c = "";
          return t === "mainnet" ? c = await window.okxwallet.bitcoin.sendBitcoin(
            f[0].address,
            f[0].satoshis,
            {}
          ) : t === "testnet" && (c = await window.okxwallet.bitcoinTestnet.sendBitcoin(
            f[0].address,
            f[0].satoshis,
            {}
          )), o(!1), c;
...
function El() {
  const { wallet: e, network: t, address: n, publicKey: r } = Te(), [a, i] = $(!1);
  return { send: H(
    async ({
      toAddress: o,
      satoshis: u,
      ...
      try {
        ...
        if (c) {
          const g = await new bt({ network: t }).relay({ hex: m.hex });
          return i(!1), {
            txId: g
          };
        }
...
function Tl() {
  const { network: e, publicKey: t, format: n, wallet: r } = Te(), [a, i] = $(null), [s, o] = $(!1);
  return { sign: H(
    async (f, c, d) => {
      o(!0);
      try {
        if (i(null), !n || !t || !r)
          throw new Error("No wallet is connected");
        const p = _t.fromBase64(c), m = await Sn({
          address: f,
          wallet: r,
          network: e,
          psbt: p,
...
async function Zo({
  ...
  if (t === C.MAGICEDEN) {
    const { base64: i } = await Oa(e, n, r);
    return i;
  }
  if (t === C.UNISAT) {
    const { base64: i } = await _a(e, "bip322-simple");
    return i;
  }
  if (t === C.XVERSE) {
    const { base64: i } = await Da(e, n, r);
    return i;
  }
  if (t === C.LEATHER) {
    const i = Jo(a), { base64: s } = await xa(e, {
      paymentType: i,
      network: r
    });
    return s;
  ...
  if (t === C.OKX) {
    const { base64: i } = await Ra(e, "bip322-simple", r);
    return i;
  }
  throw new Error("Invalid wallet selected");
}
    ...
    async (c, d) => {
      ...
      try {
        ...
        const p = await Zo({
          ...
          message: d,
          network: e,
          format: a.ordinals === c ? r.ordinals : r.payments
        });
        return u(!1), p;
      } catch (p) {
...
export {
  mt as Network,
  wl as OrdConnectKit,
  jo as SelectWalletModal,
  C as Wallet,
  ml as WallieProvider,
  vl as useBalance,
  yl as useSend,
  bl as useSendBtc,
  El as useSendV2,
  Tl as useSign,
  xl as useSignMessage,
  Te as useWallie
};
