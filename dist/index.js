...
import { signPsbt as Ba, signMessage as Wa } from "./okx.js";
import Ka from "buffer-reverse";
import { sendBtcTransaction as Va, BitcoinNetworkType as Vn, request as Xa, RpcErrorCode as Ga } from "sats-connect";
function Ya(e) {
...
function Za() {
  ...
  function s(o, u, d) {
    ...
    if (o && o.defaultProps) for (c in u = o.defaultProps, u) f[c] === void 0 && (f[c] = u[c]);
    return { $$typeof: t, type: o, key: p, ref: m, props: f, _owner: a.current };
  }
...
function Qa() {
  return Gn || (Gn = 1, dr.env.NODE_ENV !== "production" && function() {
    ...
    function y(l) {
      {
        for (var h = arguments.length, v = new Array(h > 1 ? h - 1 : 0), C = 1; C < h; C++)
          v[C - 1] = arguments[C];
        P("error", l, v);
      }
    }
    ...
    function Te(l) {
      return !!(typeof l == "string" || typeof l == "function" || l === r || l === i || pe || l === a || l === d || l === c || k || l === m || x || T || S || typeof l == "object" && l !== null && (l.$$typeof === p || l.$$typeof === f || l.$$typeof === s || l.$$typeof === o || l.$$typeof === u || // This needs to include all possible module reference object
      ...
      if (typeof l == "object")
        switch (l.$$typeof) {
          ...
          case f:
            ...
            return C !== null ? C : J(l.type) || "Memo";
          case p: {
            var M = l, D = M._payload, L = M._init;
            try {
              return J(L(D));
            } catch {
              return null;
...
` + it + l;
    ...
    function de(l, h) {
      ...
      var D;
      D = at.current, at.current = null, ce();
      try {
        if (h) {
          var L = function() {
            throw Error();
...
` + R[B].replace(" at new ", " at ");
        ...
        Xe = !1, at.current = D, In(), Error.prepareStackTrace = M;
      }
      ...
      if (typeof l == "object")
        switch (l.$$typeof) {
          case u:
            return re(l.render);
          case f:
            return bt(l.type, h, v);
          case p: {
            var C = l, M = C._payload, D = C._init;
            try {
              return bt(D(M), h, v);
            } catch {
            }
    ...
    function yt(l) {
      if (l) {
        var h = l._owner, v = bt(l.type, l._source, h ? h.type : null);
        Pn.setExtraStackFrame(v);
      } else
        Pn.setExtraStackFrame(null);
    }
    function Wr(l, h, v, C, M) {
      {
          ...
          if (D(l, L)) {
            ...
            try {
              if (typeof l[L] != "function") {
                var te = Error((C || "React class") + ": " + v + " type `" + L + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof l[L] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw te.name = "Invariant Violation", te;
              }
              R = l[L](h, L, C, v, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (B) {
              R = B;
            }
            R && !(R instanceof Error) && (yt(M), y("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", C || "React class", v, L, typeof R), yt(null)), R instanceof Error && !(R.message in On) && (On[R.message] = !0, yt(M), y("Failed %s type: %s", v, R.message), yt(null));
          }
      }
    }
    ...
    function zr(l, h) {
      if (typeof l.ref == "string" && ot.current && h && ot.current.stateNode !== h) {
        var v = J(ot.current.type);
        Vt[v] || (y('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', J(ot.current.type), l.ref), Vt[v] = !0);
      }
    }
    function Jr(l, h) {
      {
    ...
    function ea(l, h, v, C, M) {
      {
        var D, L = {}, R = null, te = null;
        v !== void 0 && (Rn(v), R = "" + v), qr(h) && (Rn(h.key), R = "" + h.key), Yr(h) && (te = h.ref, zr(h, M));
        for (D in h)
        ...
        return Qr(l, R, te, M, C, ot.current, L);
      }
    }
    var Xt = N.ReactCurrentOwner, _n = N.ReactDebugCurrentFrame;
    function qe(l) {
      if (l) {
        var h = l._owner, v = bt(l.type, l._source, h ? h.type : null);
    ...
    function Dn(l, h) {
      {
        ...
        $n[v] = !0;
        var C = "";
        l && l._owner && l._owner !== Xt.current && (C = " It was passed a child from " + J(l._owner.type) + "."), qe(l), y('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', v, C), qe(null);
      }
    }
    function jn(l, h) {
      {
        ...
        if (Kt(l))
          ...
          if (typeof M == "function" && M !== l.entries)
            for (var D = M.call(l), L; !(L = D.next()).done; )
    ...
    function Fn(l, h, v, C, M, D) {
      {
        ...
        if (!L) {
          ...
          te ? R += te : R += Mn();
          var B;
          l === null ? B = "null" : Kt(l) ? B = "array" : l !== void 0 && l.$$typeof === t ? (B = "<" + (J(l.type) || "Unknown") + " />", R = " Did you accidentally export a JSX literal instead of a component?") : B = typeof l, y("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", B, R);
        }
        var K = ea(l, h, v, M, D);
        if (K == null)
          return K;
        ...
        if (st.call(h, "key")) {
          var Fe = J(l), ae = Object.keys(h).filter(function(ca) {
            return ca !== "key";
          }), qt = ae.length > 0 ? "{key: someKey, " + ae.join(": ..., ") + ": ...}" : "{key: someKey}";
          if (!kn[Fe + qt]) {
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, qt, Fe, ua, Fe), kn[Fe + qt] = !0;
          }
        }
        return l === r ? aa(K) : ra(K), K;
      }
    }
    function ia(l, h, v) {
      return Fn(l, h, v, !0);
    ...
    var oa = sa, la = ia;
    ct.Fragment = r, ct.jsx = oa, ct.jsxs = la;
  }()), ct;
}
dr.env.NODE_ENV === "production" ? cn.exports = Za() : cn.exports = Qa();
var E = cn.exports;
function ei() {
  const [e, t] = $(!1);
  return F(() => {
...
const Je = {
  payments: null,
  ordinals: null
}, hr = we(void 0), ni = "address", ri = "wallet", ai = "publicKey", ii = "format";
function pl({
  children: e,
  initialNetwork: t,
  ssr: n = !1
...
var si = Object.defineProperty, oi = (e, t, n) => t in e ? si(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : e[t] = n, Jt = (e, t, n) => (oi(e, typeof t != "symbol" ? t + "" : t, n), n);
let li = class {
  constructor() {
...
function tt() {
  let e = ui(), [t, n] = $e.useState(Oe.isHandoffComplete);
...
var Se = ((e) => (e[e.First = 1] = "First", e[e.Previous = 2] = "Previous", e[e.Next = 4] = "Next", e[e.Last = 8] = "Last", e[e.WrapAround = 16] = "WrapAround", e[e.NoScroll = 32] = "NoScroll", e))(Se || {}), mr = ((e) => (e[e.Error = 0] = "Error", e[e.Overflow = 1] = "Overflow", e[e.Success = 2] = "Success", e[e.Underflow = 3] = "Underflow", e))(mr || {}), ci = ((e) => (e[e.Previous = -1] = "Previous", e[e.Next = 1] = "Next", e))(ci || {});
...
var di = ((e) => (e[e.Keyboard = 0] = "Keyboard", e[e.Mouse = 1] = "Mouse", e))(di || {});
...
function ht(e, t, { sorted: n = !0, relativeTo: r = null, skipElements: a = [] } = {}) {
  let i = Array.isArray(e) ? e.length > 0 ? e[0].ownerDocument : document : e.ownerDocument, s = Array.isArray(e) ? n ? vr(e) : e : gr(e);
  ...
  let o = (() => {
    ...
    throw new Error("Missing Focus.First, Focus.Previous, Focus.Next or Focus.Last");
  })(), d = t & 32 ? { preventScroll: !0 } : {}, c = 0, f = s.length, p;
  do {
    ...
    p = s[m], p == null || p.focus(d), c += o;
  } while (p !== i.activeElement);
  return t & 6 && pi(p) && p.select(), 2;
}
function br() {
...
function Er(e, t, n = !0) {
  ...
  function a(s, o) {
    ...
    for (let c of d) {
      ...
      if (f != null && f.contains(u) || s.composed && s.composedPath().includes(f)) return;
    }
  ...
  Tt("pointerdown", (s) => {
    ...
    gi() || i.current && (a(s, () => i.current), i.current = null);
  }, !0), Tt("touchend", (s) => a(s, () => s.target instanceof HTMLElement ? s.target : null), !0), yr("blur", (s) => a(s, () => window.document.activeElement instanceof HTMLIFrameElement ? window.document.activeElement : null), !0);
}
function nt(...e) {
  return V(() => kt(...e), [...e]);
}
...
function yi({ container: e, accept: t, walk: n, enabled: r = !0 }) {
  let a = _(t), i = _(n);
  F(() => {
    ...
    let s = kt(e);
    if (!s) return;
    let o = a.current, u = i.current, d = Object.assign((f) => o(f), { acceptNode: o }), c = s.createTreeWalker(e, NodeFilter.SHOW_ELEMENT, d, !1);
...
function ee({ ourProps: e, theirProps: t, slot: n, defaultTag: r, features: a, visible: i = !0, name: s, mergeRefs: o }) {
  o = o ?? Ei;
  let u = xr(t, e);
  if (i) return xt(u, n, r, s, o);
  let d = a ?? 0;
  if (d & 2) {
    let { static: c = !1, ...f } = u;
    if (c) return xt(f, n, r, s, o);
  }
  if (d & 1) {
    let { unmount: c = !0, ...f } = u;
    return G(c ? 0 : 1, { 0() {
      ...
      return xt({ ...f, hidden: !0, style: { display: "none" } }, n, r, s, o);
    } });
  }
  return xt(u, n, r, s, o);
}
function xt(e, t = {}, n, r, a) {
  let { as: i = n, children: s, refName: o = "ref", ...u } = Zt(e, ["unmount", "static"]), d = e.ref !== void 0 ? { [o]: e.ref } : {}, c = typeof s == "function" ? s(t) : s;
  ...
  if (t) {
    ...
    p && (f["data-headlessui-state"] = m.join(" "));
  }
  if (i === le && Object.keys(Zn(u)).length > 0) {
    if (!ma(c) || Array.isArray(c) && c.length > 1) throw new Error(['Passing props on "Fragment"!', "", `The current component <${r} /> is rendering a "Fragment".`, "However we need to passthrough the following props:", Object.keys(u).map((g) => `  - ${g}`).join(`
...
`));
    ...
    return ga(c, Object.assign({}, xr(c.props, Zn(Zt(u, ["ref"]))), f, d, { ref: a(c.ref, d.ref) }, w));
  }
  return wa(i, Object.assign({}, Zt(u, ["ref"]), i !== le && d, i !== le && f), c);
}
function Ei(...e) {
...
function z(e) {
  var t;
  return Object.assign(ha(e), { displayName: (t = e.displayName) != null ? t : e.name });
}
function Zn(e) {
...
function xi(e, t) {
  ...
  return ee({ ourProps: i, theirProps: a, slot: {}, defaultTag: Ti, name: "Hidden" });
}
let fn = z(xi), Tn = we(null);
...
function Ri(e, t) {
  let n = _(null), r = ne(n, t), { initialFocus: a, containers: i, features: s = 30, ...o } = e;
  tt() || (s = 1);
  let u = nt(n);
  _i({ ownerDocument: u }, !!(s & 16));
  let d = Mi({ ownerDocument: u, container: n, initialFocus: a }, !!(s & 2));
  $i({ ownerDocument: u, container: n, containers: i, previousActiveElement: d }, !!(s & 8));
  let c = Pi(), f = A((g) => {
    let b = n.current;
    b && ((N) => N())(() => {
  ...
  }), p = mt(), m = _(!1), w = { ref: r, onKeyDown(g) {
  ...
  return O.createElement(O.Fragment, null, !!(s & 4) && O.createElement(fn, { as: "button", type: "button", "data-headlessui-focus-guard": !0, onFocus: f, features: $t.Focusable }), ee({ ourProps: w, theirProps: o, defaultTag: Ai, name: "FocusTrap" }), !!(s & 4) && O.createElement(fn, { as: "button", type: "button", "data-headlessui-focus-guard": !0, onFocus: f, features: $t.Focusable }));
}
let Ni = z(Ri), dt = Object.assign(Ni, { features: Ar });
function Li(e = !0) {
  let t = _(_e.slice());
  return En(([n], [r]) => {
    r === !0 && n === !1 && jt(() => {
...
function Mi({ ownerDocument: e, container: t, initialFocus: n }, r) {
  let a = _(null), i = gt();
  return En(() => {
    if (!r) return;
    let s = t.current;
    s && jt(() => {
      ...
      n != null && n.current ? De(n.current) : ht(s, Se.First) === mr.Error && console.warn("There are no focusable elements inside the <FocusTrap />"), a.current = e == null ? void 0 : e.activeElement;
    });
  }, [r]), a;
}
function $i({ ownerDocument: e, container: t, containers: n, previousActiveElement: r }, a) {
  let i = gt();
  Ir(e == null ? void 0 : e.defaultView, "focus", (s) => {
    ...
    if (!u) return;
    let d = s.target;
    d && d instanceof HTMLElement ? Rr(o, d) ? (r.current = d, De(d)) : (s.preventDefault(), s.stopPropagation(), De(u)) : De(r.current);
  }, !0);
}
function Rr(e, t) {
...
function Fi(e, t) {
  ...
  }), d ? !s || !o ? null : Ha(ee({ ourProps: { ref: a }, theirProps: n, defaultTag: ki, name: "Portal" }), o) : null;
}
let Ui = le, Lr = we(null);
function Hi(e, t) {
  let { target: n, ...r } = e, a = { ref: ne(t) };
  return O.createElement(Lr.Provider, { value: n }, ee({ ourProps: a, theirProps: r, defaultTag: Ui, name: "Popover.Group" }));
}
let hn = we(null);
function Bi() {
  let e = ie(hn), t = _([]), n = A((i) => (t.current.push(i), e && e.register(i), () => r(i))), r = A((i) => {
...
let Wi = z(Fi), Ki = z(Hi), mn = Object.assign(Wi, { Group: Ki });
function Vi(e, t) {
  return e === t && (e !== 0 || 1 / e === 1 / t) || e !== e && t !== t;
}
const Xi = typeof Object.is == "function" ? Object.is : Vi, { useState: Gi, useEffect: Yi, useLayoutEffect: qi, useDebugValue: zi } = $e;
function Ji(e, t, n) {
  const r = t(), [{ inst: a }, i] = Gi({ inst: { value: r, getSnapshot: t } });
  return qi(() => {
    a.value = r, a.getSnapshot = t, Qt(a) && i({ inst: a });
  }, [e, r, t]), Yi(() => (Qt(a) && i({ inst: a }), e(() => {
    Qt(a) && i({ inst: a });
  })), [e]), zi(r), r;
}
function Qt(e) {
...
const Qi = typeof window < "u" && typeof window.document < "u" && typeof window.document.createElement < "u", es = !Qi, ts = es ? Zi : Ji, ns = "useSyncExternalStore" in $e ? ((e) => e.useSyncExternalStore)($e) : ts;
function rs(e) {
  return ns(e.subscribe, e.getSnapshot, e.getSnapshot);
}
function as(e, t) {
    ...
    t.microTask(() => {
      ...
      t.addEventListener(e, "click", (o) => {
        if (o.target instanceof HTMLElement) try {
          ...
          if (!u) return;
          let { hash: d } = new URL(u.href), c = e.querySelector(d);
          c && !r(c) && (s = c);
        } catch {
        }
...
let He = as(() => /* @__PURE__ */ new Map(), { PUSH(e, t) {
  var n;
  ...
  let r = { doc: e, d: t, meta: ls(n) }, a = [ss(), is(), os()];
...
function us(e, t, n) {
  let r = rs(He), a = e ? r.get(e) : void 0, i = a ? a.count > 0 : !1;
  return Y(() => {
...
function cs({ defaultContainers: e = [], portals: t, mainTreeNodeRef: n } = {}) {
  var r;
  let a = _((r = n == null ? void 0 : n.current) != null ? r : null), i = nt(a), s = A(() => {
    var o, u, d;
    let c = [];
    for (let f of e) f !== null && (f instanceof HTMLElement ? c.push(f) : "current" in f && f.current instanceof HTMLElement && c.push(f.current));
    if (t != null && t.current) for (let f of t.current) c.push(f);
    for (let f of (o = i == null ? void 0 : i.querySelectorAll("html > *, body > *")) != null ? o : []) f !== document.body && f !== document.head && f instanceof HTMLElement && f.id !== "headlessui-portal-root" && (f.contains(a.current) || f.contains((d = (u = a.current) == null ? void 0 : u.getRootNode()) == null ? void 0 : d.host) || c.some((p) => f.contains(p)) || c.push(f));
    return c;
  });
  return { resolveContainers: s, contains: A((o) => s().some((u) => u.contains(o))), mainTreeNodeRef: a, MainTreeNode: V(() => function() {
...
function fs({ children: e, onUpdate: t, type: n, element: r, enabled: a }) {
  let i = ds(), s = A((...o) => {
    t == null || t(...o), i(...o);
  });
  return Y(() => {
...
function Mr() {
  ...
  if (e === null) {
    ...
    throw Error.captureStackTrace && Error.captureStackTrace(t, Mr), t;
  }
  return e;
}
function ps() {
  ...
  return [e.length > 0 ? e.join(" ") : void 0, V(() => function(n) {
    ...
    return O.createElement(_r.Provider, { value: a }, n.children);
  }, [t])];
}
let hs = "p";
function ms(e, t) {
  let n = Re(), { id: r = `headlessui-description-${n}`, ...a } = e, i = Mr(), s = ne(t);
  Y(() => i.register(r), [r, i.register]);
  let o = { ref: s, ...i.props, id: r };
  return ee({ ourProps: o, theirProps: a, slot: i.slot || {}, defaultTag: hs, name: i.name || "Description" });
}
let gs = z(ms), ws = Object.assign(gs, {});
var vs = ((e) => (e[e.Open = 0] = "Open", e[e.Closed = 1] = "Closed", e))(vs || {}), bs = ((e) => (e[e.SetTitleId = 0] = "SetTitleId", e))(bs || {});
let ys = { 0(e, t) {
...
function Ts(e, t) {
  return G(t.type, ys, e, t);
}
let xs = "div", Cs = et.RenderStrategy | et.Static;
function Ss(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-${n}`, open: a, onClose: i, initialFocus: s, role: o = "dialog", __demoMode: u = !1, ...d } = e, [c, f] = $(0), p = _(!1);
  o = function() {
  ...
  let m = Ft();
  a === void 0 && m !== null && (a = (m & q.Open) === q.Open);
  let w = _(null), g = ne(w, t), b = nt(w), N = e.hasOwnProperty("open") || m !== null, y = e.hasOwnProperty("onClose");
  ...
  let P = a ? 0 : 1, [x, T] = ar(Ts, { titleId: null, descriptionId: null, panelRef: sn() }), S = A(() => i(!1)), k = A((U) => T({ type: 0, id: U })), pe = tt() ? u ? !1 : P === 0 : !1, ue = c > 1, Te = ie(Dt) !== null, [je, xe] = Bi(), J = { get current() {
    var U;
    return (U = x.panelRef.current) != null ? U : w.current;
  } }, { resolveContainers: se, mainTreeNodeRef: oe, MainTreeNode: We } = cs({ portals: je, defaultContainers: [J] }), ve = ue ? "parent" : "leaf", ke = m !== null ? (m & q.Closing) === q.Closing : !1, Ke = Te || ke ? !1 : pe, Ce = H(() => {
    var U, de;
  ...
  let [at, it] = ps(), Ve = V(() => [{ dialogState: P, close: S, setTitleId: k }, x], [P, x, S, k]), Xe = V(() => ({ open: P === 0 }), [P]), Ge = { ref: g, id: r, role: o, "aria-modal": P === 0 ? !0 : void 0, "aria-labelledby": x.titleId, "aria-describedby": at };
  return O.createElement(fs, { type: "Dialog", enabled: P === 0, element: w, onUpdate: A((U, de) => {
    de === "Dialog" && G(U, { [gn.Add]: () => f((re) => re + 1), [gn.Remove]: () => f((re) => re - 1) });
  }) }, O.createElement(pn, { force: !0 }, O.createElement(mn, null, O.createElement(Dt.Provider, { value: Ve }, O.createElement(mn.Group, { target: w }, O.createElement(pn, { force: !1 }, O.createElement(it, { slot: Xe, name: "Dialog.Description" }, O.createElement(dt, { initialFocus: s, containers: se, features: pe ? G(ve, { parent: dt.features.RestoreFocus, leaf: dt.features.All & ~dt.features.FocusLock }) : dt.features.None }, O.createElement(xe, null, ee({ ourProps: Ge, theirProps: d, slot: Xe, defaultTag: xs, features: Cs, visible: P === 0, name: "Dialog" }))))))))), O.createElement(We, null));
}
let Is = "div";
function Os(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-overlay-${n}`, ...a } = e, [{ dialogState: i, close: s }] = wt("Dialog.Overlay"), o = ne(t), u = A((c) => {
    if (c.target === c.currentTarget) {
      if (Sr(c.currentTarget)) return c.preventDefault();
      c.preventDefault(), c.stopPropagation(), s();
    }
  }), d = V(() => ({ open: i === 0 }), [i]);
  return ee({ ourProps: { ref: o, id: r, "aria-hidden": !0, onClick: u }, theirProps: a, slot: d, defaultTag: Is, name: "Dialog.Overlay" });
}
let Ps = "div";
function As(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-backdrop-${n}`, ...a } = e, [{ dialogState: i }, s] = wt("Dialog.Backdrop"), o = ne(t);
  F(() => {
  ...
  let u = V(() => ({ open: i === 0 }), [i]);
  return O.createElement(pn, { force: !0 }, O.createElement(mn, null, ee({ ourProps: { ref: o, id: r, "aria-hidden": !0 }, theirProps: a, slot: u, defaultTag: Ps, name: "Dialog.Backdrop" })));
}
let Rs = "div";
function Ns(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-panel-${n}`, ...a } = e, [{ dialogState: i }, s] = wt("Dialog.Panel"), o = ne(t, s.panelRef), u = V(() => ({ open: i === 0 }), [i]), d = A((c) => {
    c.stopPropagation();
  });
  return ee({ ourProps: { ref: o, id: r, onClick: d }, theirProps: a, slot: u, defaultTag: Rs, name: "Dialog.Panel" });
}
let Ls = "h2";
function _s(e, t) {
  let n = Re(), { id: r = `headlessui-dialog-title-${n}`, ...a } = e, [{ dialogState: i, setTitleId: s }] = wt("Dialog.Title"), o = ne(t);
  F(() => (s(r), () => s(null)), [r, s]);
  let u = V(() => ({ open: i === 0 }), [i]);
  return ee({ ourProps: { ref: o, id: r }, theirProps: a, slot: u, defaultTag: Ls, name: "Dialog.Title" });
}
let Ms = z(Ss), $s = z(As), Ds = z(Ns), js = z(Os), ks = z(_s), tn = Object.assign(Ms, { Backdrop: $s, Panel: Ds, Overlay: js, Title: ks, Description: ws }), er = /([\u2700-\u27BF]|[\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2011-\u26FF]|\uD83E[\uDD10-\uDDFF])/g;
function tr(e) {
  var t, n;
...
function Us(e) {
  ...
  return A(() => {
    ...
    let i = Fs(r).trim().toLowerCase();
    return t.current = a, n.current = i, i;
  });
}
var Hs = ((e) => (e[e.Open = 0] = "Open", e[e.Closed = 1] = "Closed", e))(Hs || {}), Bs = ((e) => (e[e.Pointer = 0] = "Pointer", e[e.Other = 1] = "Other", e))(Bs || {}), Ws = ((e) => (e[e.OpenMenu = 0] = "OpenMenu", e[e.CloseMenu = 1] = "CloseMenu", e[e.GoToItem = 2] = "GoToItem", e[e.Search = 3] = "Search", e[e.ClearSearch = 4] = "ClearSearch", e[e.RegisterItem = 5] = "RegisterItem", e[e.UnregisterItem = 6] = "UnregisterItem", e))(Ws || {});
function nn(e, t = (n) => n) {
  let n = e.activeItemIndex !== null ? e.items[e.activeItemIndex] : null, r = vr(t(e.items.slice()), (i) => i.dataRef.current.domRef.current), a = n ? r.indexOf(n) : null;
...
let Ks = { 1(e) {
  ...
  var n;
  let r = nn(e), a = Oi(t, { resolveItems: () => r.items, resolveActiveIndex: () => r.activeItemIndex, resolveId: (i) => i.id, resolveDisabled: (i) => i.dataRef.current.disabled });
...
function Vs(e, t) {
  return G(t.type, Ks, e, t);
}
let Xs = le;
function Gs(e, t) {
  let { __demoMode: n = !1, ...r } = e, a = ar(Vs, { __demoMode: n, menuState: n ? 0 : 1, buttonRef: sn(), itemsRef: sn(), items: [], searchQuery: "", activeItemIndex: null, activationTrigger: 1 }), [{ menuState: i, itemsRef: s, buttonRef: o }, u] = a, d = ne(t);
  Er([o, s], (m, w) => {
    var g;
    u({ type: 1 }), yn(w, bn.Loose) || (m.preventDefault(), (g = o.current) == null || g.focus());
  }, i === 0);
  let c = A(() => {
    u({ type: 1 });
  }), f = V(() => ({ open: i === 0, close: c }), [i, c]), p = { ref: d };
  return O.createElement(Cn.Provider, { value: a }, O.createElement(Cr, { value: G(i, { 0: q.Open, 1: q.Closed }) }, ee({ ourProps: p, theirProps: r, slot: f, defaultTag: Xs, name: "Menu" })));
}
let Ys = "button";
function qs(e, t) {
  var n;
  let r = Re(), { id: a = `headlessui-menu-button-${r}`, ...i } = e, [s, o] = Ut("Menu.Button"), u = ne(s.buttonRef, t), d = mt(), c = A((g) => {
    switch (g.key) {
      case X.Space:
      case X.Enter:
      case X.ArrowDown:
        g.preventDefault(), g.stopPropagation(), o({ type: 0 }), d.nextFrame(() => o({ type: 2, focus: me.First }));
        break;
      case X.ArrowUp:
        g.preventDefault(), g.stopPropagation(), o({ type: 0 }), d.nextFrame(() => o({ type: 2, focus: me.Last }));
        break;
    }
  }), f = A((g) => {
    switch (g.key) {
    ...
    e.disabled || (s.menuState === 0 ? (o({ type: 1 }), d.nextFrame(() => {
      var b;
      return (b = s.buttonRef.current) == null ? void 0 : b.focus({ preventScroll: !0 });
    })) : (g.preventDefault(), o({ type: 0 })));
  }), m = V(() => ({ open: s.menuState === 0 }), [s]), w = { ref: u, id: a, type: wi(e, s.buttonRef), "aria-haspopup": "menu", "aria-controls": (n = s.itemsRef.current) == null ? void 0 : n.id, "aria-expanded": s.menuState === 0, onKeyDown: c, onKeyUp: f, onClick: p };
  return ee({ ourProps: w, theirProps: i, slot: m, defaultTag: Ys, name: "Menu.Button" });
}
let zs = "div", Js = et.RenderStrategy | et.Static;
function Zs(e, t) {
  var n, r;
  let a = Re(), { id: i = `headlessui-menu-items-${a}`, ...s } = e, [o, u] = Ut("Menu.Items"), d = ne(o.itemsRef, t), c = nt(o.itemsRef), f = mt(), p = Ft(), m = p !== null ? (p & q.Open) === q.Open : o.menuState === 0;
  F(() => {
    let y = o.itemsRef.current;
    y && o.menuState === 0 && y !== (c == null ? void 0 : c.activeElement) && y.focus({ preventScroll: !0 });
  }, [o.menuState, o.itemsRef, c]), yi({ container: o.itemsRef.current, enabled: o.menuState === 0, accept(y) {
  ...
  let w = A((y) => {
    ...
    switch (f.dispose(), y.key) {
      ...
      case X.Tab:
        y.preventDefault(), y.stopPropagation(), u({ type: 1 }), ge().nextFrame(() => {
          hi(o.buttonRef.current, y.shiftKey ? Se.Previous : Se.Next);
        });
        break;
      default:
        y.key.length === 1 && (u({ type: 3, value: y.key }), f.setTimeout(() => u({ type: 4 }), 350));
        break;
    }
  }), g = A((y) => {
    switch (y.key) {
  ...
  }), b = V(() => ({ open: o.menuState === 0 }), [o]), N = { "aria-activedescendant": o.activeItemIndex === null || (n = o.items[o.activeItemIndex]) == null ? void 0 : n.id, "aria-labelledby": (r = o.buttonRef.current) == null ? void 0 : r.id, id: i, onKeyDown: w, onKeyUp: g, role: "menu", tabIndex: 0, ref: d };
  return ee({ ourProps: N, theirProps: s, slot: b, defaultTag: zs, features: Js, visible: m, name: "Menu.Items" });
}
let Qs = le;
function eo(e, t) {
  let n = Re(), { id: r = `headlessui-menu-item-${n}`, disabled: a = !1, ...i } = e, [s, o] = Ut("Menu.Item"), u = s.activeItemIndex !== null ? s.items[s.activeItemIndex].id === r : !1, d = _(null), c = ne(t, d);
  Y(() => {
    if (s.__demoMode || s.menuState !== 0 || !u || s.activationTrigger === 0) return;
    let T = ge();
    return T.requestAnimationFrame(() => {
      var S, k;
      (k = (S = d.current) == null ? void 0 : S.scrollIntoView) == null || k.call(S, { block: "nearest" });
    }), T.dispose;
  }, [s.__demoMode, d, u, s.menuState, s.activationTrigger, s.activeItemIndex]);
  let f = Us(d), p = _({ disabled: a, domRef: d, get textValue() {
    return f();
  } });
  Y(() => {
    p.current.disabled = a;
  }, [p, a]), Y(() => (o({ type: 5, id: r, dataRef: p }), () => o({ type: 6, id: r })), [p, r]);
  let m = A(() => {
    o({ type: 1 });
  }), w = A((T) => {
    ...
    if (a) return o({ type: 2, focus: me.Nothing });
    o({ type: 2, focus: me.Specific, id: r });
  }), b = bi(), N = A((T) => b.update(T)), y = A((T) => {
    b.wasMoved(T) && (a || u || o({ type: 2, focus: me.Specific, id: r, trigger: 0 }));
  }), P = A((T) => {
    b.wasMoved(T) && (a || u && o({ type: 2, focus: me.Nothing }));
  }), x = V(() => ({ active: u, disabled: a, close: m }), [u, a, m]);
  return ee({ ourProps: { id: r, ref: c, role: "menuitem", tabIndex: a === !0 ? void 0 : -1, "aria-disabled": a === !0 ? !0 : void 0, disabled: void 0, onClick: w, onFocus: g, onPointerEnter: N, onMouseEnter: N, onPointerMove: y, onMouseMove: y, onPointerLeave: P, onMouseLeave: P }, theirProps: i, slot: x, defaultTag: Qs, name: "Menu.Item" });
}
let to = z(Gs), no = z(qs), ro = z(Zs), ao = z(eo), Ze = Object.assign(to, { Button: no, Items: ro, Item: ao });
function io(e = 0) {
  let [t, n] = $(e), r = gt(), a = H((u) => {
    r.current && n((d) => d | u);
...
function oo(e, t) {
  ...
  let { transitionDuration: r, transitionDelay: a } = getComputedStyle(e), [i, s] = [r, a].map((u) => {
    let [d = 0] = u.split(",").filter(Boolean).map((c) => c.includes("ms") ? parseFloat(c) : parseFloat(c) * 1e3).sort((c, f) => f - c);
    return d;
  }), o = i + s;
  if (o !== 0) {
    n.group((d) => {
      d.setTimeout(() => {
        t(), d.dispose();
      }, o), d.addEventListener(e, "transitionrun", (c) => {
        c.target === c.currentTarget && d.dispose();
      });
    });
    let u = n.addEventListener(e, "transitionend", (d) => {
...
function lo(e, t, n, r) {
  let a = n ? "enter" : "leave", i = ge(), s = r !== void 0 ? so(r) : () => {
  };
  a === "enter" && (e.removeAttribute("hidden"), e.style.display = "");
  let o = G(a, { enter: () => t.enter, leave: () => t.leave }), u = G(a, { enter: () => t.enterTo, leave: () => t.leaveTo }), d = G(a, { enter: () => t.enterFrom, leave: () => t.leaveFrom });
  return an(e, ...t.base, ...t.enter, ...t.enterTo, ...t.enterFrom, ...t.leave, ...t.leaveFrom, ...t.leaveTo, ...t.entered), rn(e, ...t.base, ...o, ...d), i.nextFrame(() => {
    an(e, ...t.base, ...o, ...d), rn(e, ...t.base, ...o, ...u), oo(e, () => (an(e, ...t.base, ...o), rn(e, ...t.base, ...t.entered), s()));
  }), i.dispose;
}
function uo({ immediate: e, container: t, direction: n, classes: r, onStart: a, onStop: i }) {
  ...
  Y(() => {
    ...
    o.add(d.dispose);
    let c = t.current;
    if (c && u.current !== "idle" && s.current) return d.dispose(), a.current(u.current), d.add(lo(c, r.current, u.current === "enter", () => {
      d.dispose(), i.current(u.current);
    })), d.dispose;
  }, [n]);
}
function Le(e = "") {
...
function $r(e, t) {
  let n = Pe(e), r = _([]), a = gt(), i = mt(), s = A((m, w = Me.Hidden) => {
    ...
    g !== -1 && (G(w, { [Me.Unmount]() {
      ...
      var b;
      !Wt(r) && a.current && ((b = n.current) == null || b.call(n));
    }));
  }), o = A((m) => {
    let w = r.current.find(({ el: g }) => g === m);
    return w ? w.state !== "visible" && (w.state = "visible") : r.current.push({ el: m, state: "visible" }), () => s(m, Me.Unmount);
  }), u = _([]), d = _(Promise.resolve()), c = _({ enter: [], leave: [], idle: [] }), f = A((m, w, g) => {
    u.current.splice(0), t && (t.chains.current[w] = t.chains.current[w].filter(([b]) => b !== m)), t == null || t.chains.current[w].push([m, new Promise((b) => {
      u.current.push(b);
    })]), t == null || t.chains.current[w].push([m, new Promise((b) => {
      Promise.all(c.current[w].map(([N, y]) => y)).then(() => b());
    })]), w === "enter" ? d.current = d.current.then(() => t == null ? void 0 : t.wait.current).then(() => g(w)) : g(w);
  }), p = A((m, w, g) => {
    Promise.all(c.current[w].splice(0).map(([b, N]) => N)).then(() => {
      var b;
      (b = u.current.shift()) == null || b();
    }).then(() => g(w));
  });
  return V(() => ({ children: r, register: o, unregister: s, onStart: f, onStop: p, wait: d, chains: c }), [o, s, r, f, p, c, d]);
}
function ho() {
}
...
function nr(e) {
  var t;
  let n = {};
  for (let r of mo) n[r] = (t = e[r]) != null ? t : ho;
  return n;
}
function go(e) {
  let t = _(nr(e));
...
let wo = "div", Dr = et.RenderStrategy;
function vo(e, t) {
  var n, r;
  let { beforeEnter: a, afterEnter: i, beforeLeave: s, afterLeave: o, enter: u, enterFrom: d, enterTo: c, entered: f, leave: p, leaveFrom: m, leaveTo: w, ...g } = e, b = _(null), N = ne(b, t), y = (n = g.unmount) == null || n ? Me.Unmount : Me.Hidden, { show: P, appear: x, initial: T } = fo(), [S, k] = $(P ? "visible" : "hidden"), pe = po(), { register: ue, unregister: Te } = pe;
  F(() => ue(b), [ue, b]), F(() => {
    if (y === Me.Hidden && b.current) {
      if (P && S !== "visible") {
        k("visible");
        return;
      }
  ...
  let je = Pe({ base: Le(g.className), enter: Le(u), enterFrom: Le(d), enterTo: Le(c), entered: Le(f), leave: Le(p), leaveFrom: Le(m), leaveTo: Le(w) }), xe = go({ beforeEnter: a, afterEnter: i, beforeLeave: s, afterLeave: o }), J = tt();
  F(() => {
    if (J && S === "visible" && b.current === null) throw new Error("Did you forget to passthrough the `ref` to the actual DOM node?");
  }, [b, S, J]);
  let se = T && !x, oe = x && P && T, We = !J || se ? "idle" : P ? "enter" : "leave", ve = io(0), ke = A((ce) => G(ce, { enter: () => {
  ...
  uo({ immediate: oe, container: b, classes: je, direction: We, onStart: Pe((ce) => {
    Ne.current = !0, Ce.onStart(b, ce, ke);
  }), onStop: Pe((ce) => {
    Ne.current = !1, Ce.onStop(b, ce, Ke), ce === "leave" && !Wt(Ce) && (k("hidden"), Te(b));
  }) });
  let he = g, rt = { ref: N };
  return oe ? he = { ...he, className: Mt(g.className, ...je.current.enter, ...je.current.enterFrom) } : Ne.current && (he.className = Mt(g.className, (r = b.current) == null ? void 0 : r.className), he.className === "" && delete he.className), O.createElement(Bt.Provider, { value: Ce }, O.createElement(Cr, { value: G(S, { visible: q.Open, hidden: q.Closed }) | ve.flags }, ee({ ourProps: rt, theirProps: he, defaultTag: wo, features: Dr, visible: S === "visible", name: "Transition.Child" })));
}
function bo(e, t) {
  let { show: n, appear: r = !1, unmount: a = !0, ...i } = e, s = _(null), o = ne(s, t);
  tt();
  let u = Ft();
  ...
  return /* @__PURE__ */ E.jsx(
    Ze,
    {
      ...
      children: ({ open: s }) => /* @__PURE__ */ E.jsxs(E.Fragment, { children: [
        /* @__PURE__ */ E.jsxs(Ze.Button, { children: [
          ...
          /* @__PURE__ */ E.jsxs("section", { className: "address-container", children: [
            ...
            /* @__PURE__ */ E.jsxs("section", { className: "network-container", children: [
              ...
              /* @__PURE__ */ E.jsx("p", { className: "network", children: Io[t] ?? t })
            ] })
          ] }),
          /* @__PURE__ */ E.jsx(
            "img",
        ...
        /* @__PURE__ */ E.jsx(
          Nt,
          {
            ...
            children: /* @__PURE__ */ E.jsxs(Ze.Items, { className: "ord-wallet-connection-dropdown", children: [
              /* @__PURE__ */ E.jsxs(
                Ze.Item,
                {
                  as: "button",
              ...
              /* @__PURE__ */ E.jsxs(
                Ze.Item,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ E.jsx("img", { src: xo, className: "logout-icon", alt: "logout" })
                  ]
                }
              )
            ] })
...
function Ct({
  ...
  const { wallet: o, address: u } = Ee(), [{ connectedWallet: d, connectedAddress: c }] = $({
    connectedWallet: o,
    connectedAddress: u
  }), [f, p] = $(!1), m = Mo[e], w = H(async () => {
  ...
  return /* @__PURE__ */ E.jsxs(
    "button",
    {
      ...
      children: [
        ...
        d === e && c.ordinals ? /* @__PURE__ */ E.jsx("div", { className: "wallie-flex wallie-flex-row wallie-ml-auto", children: /* @__PURE__ */ E.jsx("span", { className: "wallie-text-sm wallie-font-medium wallie-pr-3", children: vn(c.ordinals) }) }) : null,
        f && /* @__PURE__ */ E.jsx(
          "img",
          {
            src: _o,
...
function Do({
  ...
  const {
    ...
    (x, T) => {
      T instanceof La && window.open(
        $o[x],
        "_blank",
        "noopener,noreferrer"
      ), m(T.message ?? T.toString()), f();
    },
    [f]
  ), b = H(async () => {
    if (r === "testnet") {
    ...
    try {
      ...
      const x = await Ta(r);
      if (!x || x.length < 1)
        throw f(), new Error("Magic Eden via Ordit returned no addresses.");
      const T = x.find(
    ...
    async ({ readOnly: x } = {}) => {
      try {
        m("");
        const T = await Ia(r, x);
        if (!T || T.length < 1)
          throw f(), new Error("Unisat via Ordit returned no addresses.");
        const S = T[0];
        return n({
          ordinals: S.address,
          payments: S.address
    ...
    try {
      ...
      const x = await Aa(r);
      if (!x || x.length < 1)
        throw f(), new Error("Xverse via Ordit returned no addresses.");
      const T = x.find(
    ...
    try {
      ...
      const x = await va(r);
      if (!x || x.length < 1)
        throw f(), new Error("Leather via Ordit returned no addresses.");
      const T = x.find(
        (k) => k.format === "segwit"
      );
      if (!T)
...
function ml({
  ...
  const {
    ...
    openModal: c,
    closeModal: f
  } = Ee(), p = ei(), m = () => n ? null : s != null && s.ordinals ? /* @__PURE__ */ E.jsx(
    Oo,
    {
      address: s.ordinals,
      network: u,
  ...
  return /* @__PURE__ */ E.jsxs(E.Fragment, { children: [
    m(),
    p ? /* @__PURE__ */ E.jsx(Do, { isOpen: d, closeModal: f }) : null
  ] });
}
class jo {
...
class St {
  ...
  static parseInscription(t, { decodeMetadata: n }) {
    return {
      ...t,
      meta: n && t.meta ? _a(t.meta) : t.meta
    };
  }
  /**
   * Parses inscriptions.
...
class vt extends jo {
  ...
  async getInscription({
    ...
    if (!t)
      throw new Q("Invalid request");
    const r = Hn(t), a = await Z[this.network].call(
      "Ordinals.GetInscription",
      { id: r },
      Z.id
    );
    return St.parseInscription(a, { decodeMetadata: n });
  }
  ...
  async getInscriptions({
    ...
    let c = [], f = d;
    do {
      const { inscriptions: p, pagination: m } = await Z[this.network].call(
        "Ordinals.GetInscriptions",
        {
          filter: { creator: t, owner: n, mimeType: r, mimeSubType: a, outpoint: i },
          sort: { number: o },
          pagination: { limit: u, next: f }
        },
        Z.id
      );
      c = c.concat(p), f = m.next;
    } while (f !== null);
  ...
  async getTransaction({
    ...
    if (!t)
      throw new Q("Invalid request");
    const s = await Z[this.network].call(
  ...
  async getUnspents({
    ...
    let o = [], u = s;
    do {
      const { unspents: d, pagination: c } = await Z[this.network].call(
        "Address.GetUnspents",
        {
          address: t,
          options: {
...
function gl() {
  const { network: e, publicKey: t, format: n } = Ee(), [r, a] = $(null), [i, s] = $(!1);
  return { getBalance: H(async () => {
    ...
    try {
      ...
      const { address: u } = Ma(
        ...
        e,
        $a[n.payments]
      )[0], c = await new vt({ network: e }).getBalance({ address: u }), f = Number(
...
async function Sn({
  ...
  var u, d;
  if ((u = a == null ? void 0 : a.signingIndexes) != null && u.length && ((d = a == null ? void 0 : a.inputsToSign) != null && d.length))
    throw new Error("Cannot have both indexes and inputs to sign together");
  const i = (a == null ? void 0 : a.finalize) ?? !0, s = (a == null ? void 0 : a.extractTx) ?? !0, o = () => r.data.inputs.map((c, f) => f);
  if (t === I.MAGICEDEN)
    return await xa(r, {
      network: n,
...
class Wo {
   ...
   */
  calculateNetworkFee() {
    if (this.fee = this.calculateVirtualSize() * this.feeRate, this.fee > Da)
  ...
  getBaseSize() {
    ...
    let o = 0;
    return (d = this.witness) != null && d.length ? o = s : s > 0 && (o = r + s), {
      baseSize: a.input + Bo + i,
      witnessSize: o
    };
  }
...
function Xo({
  ...
  const a = sr(Be.from(t, "hex"), "p2sh", n);
...
async function Yo({
  ...
  switch (e.scriptPubKey.type) {
    ...
    case "witness_v0_keyhash":
      return Vo({ utxo: e, sighashType: r });
    case "scripthash":
      return Xo({ utxo: e, pubKey: t, network: n, sighashType: r });
    case "pubkeyhash":
      return Go({
        utxo: e,
        sighashType: r,
...
class Br extends Wo {
  constructor({
    ...
    this.address = n, this.changeAddress = r, this.datasource = a || new vt({ network: this.network }), this.outputs = u, this.publicKey = o, this.autoAdjustment = d, this.instantTradeMode = c, this.psbt = new _t({ network: Lt(s) });
  }
  get data() {
    return {
      fee: this.fee,
   ...
   */
  get xKey() {
    return ir(Be.from(this.publicKey, "hex")).toString("hex");
  }
  get inputsToSign() {
    const n = this.instantTradeMode && !this.autoAdjustment;
    return this.psbt.txInputs.reduce(
      (r, a, i) => ((!this.instantTradeMode || this.instantTradeMode && i !== Fa) && (r.signingIndexes = r.signingIndexes.concat(i)), n && (r.sigHash = // eslint-disable-next-line no-bitwise
...
function wl() {
  const { wallet: e, network: t, address: n, publicKey: r } = Ee(), [a, i] = $(null), [s, o] = $(!1);
  return { send: H(
    async (d, c, f, p = !0) => {
      o(!0);
      try {
        ...
        if (p) {
          const b = await new vt({ network: t }).relay({ hex: w.hex });
          return o(!1), b;
        }
        return o(!1), w.hex;
      } catch (m) {
    ...
    async (d) => {
      ...
      try {
        ...
        if (e === "magiceden") {
          const c = await Ca();
          let f = null;
          return f = await new Promise((p, m) => {
            Va({
              payload: {
                network: {
        ...
        if (e === "xverse") {
          ...
          try {
            ...
            if (f.status === "success")
              c = f.result.txid;
            else throw f.error.code === Ga.USER_REJECTION ? new Error("Transaction canceled") : new Error("Transaction canceled");
          } catch {
...
function bl() {
  const { wallet: e, network: t, address: n, publicKey: r } = Ee(), [a, i] = $(!1);
  return { send: H(
    async ({
      toAddress: o,
      satoshis: u,
...
function yl() {
  const { network: e, publicKey: t, format: n, wallet: r } = Ee(), [a, i] = $(null), [s, o] = $(!1);
  return { sign: H(
    async (d, c, f) => {
      o(!0);
      try {
...
async function zo({
  ...
  if (t === I.MAGICEDEN) {
    const { base64: i } = await Sa(e, n, r);
    return i;
  }
  if (t === I.UNISAT) {
    const { base64: i } = await Pa(e, "bip322-simple");
    return i;
  }
  if (t === I.XVERSE) {
    const { base64: i } = await Na(e, n, r);
    return i;
  }
  if (t === I.LEATHER) {
    const i = qo(a), { base64: s } = await Ea(e, {
      paymentType: i,
      network: r
    });
    return s;
  ...
  if (t === I.OKX) {
    const { base64: i } = await Wa(e, "bip322-simple", r);
    return i;
  }
  throw new Error("Invalid wallet selected");
}
...
export {
  Rt as Network,
  ml as OrdConnectKit,
  Do as SelectWalletModal,
  I as Wallet,
  pl as WallieProvider,
  gl as useBalance,
  wl as useSend,
  vl as useSendBtc,
  bl as useSendV2,
  yl as useSign,
  El as useSignMessage,
  Ee as useWallie
};
